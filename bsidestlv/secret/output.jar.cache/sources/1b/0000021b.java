...
/* loaded from: output.jar:androidx/appcompat/widget/SwitchCompat.class */
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SwitchCompat$EmojiCompatInitCallback.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SwitchCompat$InspectionCompanion.class */
        ...
        if (drawable2 != null) {
            ...
            if (opticalBounds != null) {
                ...
                if (opticalBounds.left > rect.left) {
                    i4 = i5 + (opticalBounds.left - rect.left);
                }
                ...
                if (opticalBounds.bottom > rect.bottom) {
                    ...
                    this.mTrackDrawable.setBounds(i4, i3, i7, i2);
                    i9 = i10;
                }
            } else {
                i = i6;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            i6 = paddingLeft;
            width = ((this.mSwitchWidth + paddingLeft) - i5) - i10;
        } else {
