...
/* loaded from: output.jar:androidx/constraintlayout/core/state/Transition.class */
public class Transition implements TypedValues {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/Transition$KeyPosition.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/Transition$WidgetState.class */
    ...
    private WidgetState getWidgetState(String str, ConstraintWidget constraintWidget, int i) {
        ...
        if (widgetState == null) {
            ...
            this.mBundle.applyDelta(widgetState3.motionControl);
            this.state.put(str, widgetState3);
    ...
    public void addKeyPosition(String str, int i, int i2, float f, float f2) {
        ...
        if (hashMap == null) {
            ...
            this.keyPositions.put(Integer.valueOf(i), hashMap2);
        }
