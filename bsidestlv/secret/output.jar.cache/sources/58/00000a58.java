...
/* loaded from: output.jar:androidx/vectordrawable/graphics/drawable/PathInterpolatorCompat.class */
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        int i5 = min - 1;
        throw new IllegalArgumentException("The Path must start at (0,0) and end at (1,1) start: " + this.mX[0] + "," + this.mY[0] + " end:" + this.mX[i5] + "," + this.mY[i5]);
    }
