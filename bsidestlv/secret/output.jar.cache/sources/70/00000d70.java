...
/* loaded from: output.jar:com/google/android/material/timepicker/ClockFaceView.class */
    ...
    private void updateTextViews(int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.values.length, size); i2++) {
            ...
            if (i2 >= this.values.length) {
                ...
                if (textView == null) {
                    textView2 = (TextView) from.inflate(R.layout.material_clockface_textview, (ViewGroup) this, false);
                    this.textViewPool.put(i2, textView2);
                    addView(textView2);
                }
                textView2.setVisibility(0);
                textView2.setText(this.values[i2]);
                textView2.setTag(R.id.material_value_index, Integer.valueOf(i2));
                ViewCompat.setAccessibilityDelegate(textView2, this.valueAccessibilityDelegate);
                textView2.setTextColor(this.textColor);
                if (i != 0) {
                    textView2.setContentDescription(getResources().getString(i, this.values[i2]));
                }
            }
        }
    }
