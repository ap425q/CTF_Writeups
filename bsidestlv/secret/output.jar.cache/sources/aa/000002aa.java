...
/* loaded from: output.jar:androidx/constraintlayout/core/motion/parse/KeyParser.class */
public class KeyParser {

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/constraintlayout/core/motion/parse/KeyParser$DataType.class */
    public interface DataType {
        int get(int i);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/constraintlayout/core/motion/parse/KeyParser$Ids.class */
