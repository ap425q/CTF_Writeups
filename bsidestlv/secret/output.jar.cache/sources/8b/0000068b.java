...
/* loaded from: output.jar:androidx/core/widget/AutoScrollHelper.class */
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    /* loaded from: output.jar:androidx/core/widget/AutoScrollHelper$ClampedScroller.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/core/widget/AutoScrollHelper$ScrollAnimationRunnable.class */
    ...
    private float constrainEdgeValue(float f, float f2) {
        ...
        if (i == 0 || i == 1) {
            if (f < f2) {
                return f >= 0.0f ? 1.0f - (f / f2) : (this.mAnimating && i == 1) ? 1.0f : 0.0f;
            }
            return 0.0f;
        } else if (i == 2 && f < 0.0f) {
            return f / (-f2);
