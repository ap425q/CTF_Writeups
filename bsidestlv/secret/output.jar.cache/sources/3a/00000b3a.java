...
/* loaded from: output.jar:com/google/android/material/bottomnavigation/BottomNavigationMenuView.class */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i14], BasicMeasure.EXACTLY), makeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                i13 += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i13, View.MeasureSpec.makeMeasureSpec(i13, BasicMeasure.EXACTLY), 0), View.resolveSizeAndState(size3, i2, 0));
    }
