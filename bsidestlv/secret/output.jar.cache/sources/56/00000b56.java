...
/* loaded from: output.jar:com/google/android/material/button/MaterialButton.class */
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    /* loaded from: output.jar:com/google/android/material/button/MaterialButton$IconGravity.class */
    public @interface IconGravity {
    }

    /* loaded from: output.jar:com/google/android/material/button/MaterialButton$OnCheckedChangeListener.class */
    public interface OnCheckedChangeListener {
        void onCheckedChanged(MaterialButton materialButton, boolean z);
    }

    /* loaded from: output.jar:com/google/android/material/button/MaterialButton$OnPressedChangeListener.class */
    interface OnPressedChangeListener {
        void onPressedChanged(MaterialButton materialButton, boolean z);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:com/google/android/material/button/MaterialButton$SavedState.class */
    ...
    */
    ...
    private int getTextHeight() {
        ...
        if (getTransformationMethod() != null) {
            str = getTransformationMethod().getTransformation(obj, this).toString();
        }
        Rect rect = new Rect();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x00bc, code lost:
        if (r0 == r7.icon) goto L27;
     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00cf, code lost:
        if (r0 == r7.icon) goto L31;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
