...
/* loaded from: output.jar:androidx/emoji2/text/EmojiCompatInitializer.class */
public class EmojiCompatInitializer implements Initializer<Boolean> {
    private static final long STARTUP_THREAD_CREATION_DELAY_MS = 500;
    private static final String S_INITIALIZER_THREAD_NAME = "EmojiCompatInitializer";

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompatInitializer$BackgroundDefaultConfig.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompatInitializer$BackgroundDefaultLoader.class */
    public static class BackgroundDefaultLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: doLoad */
        public void m269x5cc8028a(final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback, final ThreadPoolExecutor threadPoolExecutor) {
            try {
        ...
        public void load(final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback) {
            ...
            createBackgroundPriorityExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.EmojiCompatInitializer$BackgroundDefaultLoader$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    EmojiCompatInitializer.BackgroundDefaultLoader.this.m269x5cc8028a(metadataRepoLoaderCallback, createBackgroundPriorityExecutor);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompatInitializer$LoadEmojiCompatRunnable.class */
