...
/* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionController.class */
public class MotionController {
    ...
    void buildBounds(float[] fArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (easing != null) {
                ...
                d = (((float) easing.get((f5 - f9) / f)) * (f10 - f9)) + f9;
            }
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (easing != null) {
                ...
                d = (((float) easing.get((f5 - f9) / f)) * (f12 - f9)) + f9;
            }
            this.mSpline[0].getPos(d, this.mInterpolateData);
            CurveFit curveFit = this.mArcSpline;
            if (curveFit != null) {
            ...
            if (viewOscillator2 != null) {
                ...
                int i5 = i3 + 1;
                fArr[i5] = fArr[i5] + viewSpline2.get(f5);
            }
        }
    }
    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (this.mQuantizeMotionSteps != Key.UNSET) {
            ...
            if (!Float.isNaN(this.mQuantizeMotionPhase)) {
                f5 = (f4 + this.mQuantizeMotionPhase) % 1.0f;
            }
        ...
        if (curveFitArr != null) {
            ...
            if (!this.mNoMovement) {
                this.mStartMotionPath.setView(f2, view, this.mInterpolateVariables, this.mInterpolateData, this.mInterpolateVelocity, null, this.mForceMeasure);
            ...
            if (this.mKeyTriggers != null) {
                ...
                while (true) {
                    ...
                    keyTriggerArr[i2].conditionallyFire(f2, view);
                    i2++;
                }
            }
        } else {
            float f6 = this.mStartMotionPath.x + ((this.mEndMotionPath.x - this.mStartMotionPath.x) * f2) + 0.5f;
            int i3 = (int) f6;
            float f7 = this.mStartMotionPath.y + ((this.mEndMotionPath.y - this.mStartMotionPath.y) * f2) + 0.5f;
            int i4 = (int) f7;
            int i5 = (int) (f6 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f2));
            int i6 = (int) (f7 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f2));
    ...
    public void setEndState(Rect rect, ConstraintSet constraintSet, int i, int i2) {
        ...
        this.mEndPoint.setState(rect2, constraintSet, i3, this.mId);
    }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr2 = new double[size][this.mInterpolateVariables.length];
        ...
        while (true) {
                ...
                if (i17 < size) {
                    ...
                    if (motionPathsArr[i17].hasCustomData(str8)) {
                        ...
                        if (dArr == null) {
                            ...
                            dArr7 = new double[size][motionPathsArr[i17].getCustomDataCount(str8)];
                        }
                        dArr4[i18] = motionPathsArr[i17].time;
                        motionPathsArr[i17].getCustomData(str8, dArr7[i18], 0);
                        i19 = i18 + 1;
                        dArr6 = dArr4;
                    }
                    i17++;
            ...
            i16++;
            this.mSpline[i16] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr4, i18), (double[][]) Arrays.copyOf(dArr, i18));
        }
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i20 = 0; i20 < size; i20++) {
                ...
                dArr8[i20] = motionPathsArr[i20].time;
                dArr9[i20][0] = motionPathsArr[i20].x;
                dArr9[i20][1] = motionPathsArr[i20].y;
            }
