...
/* loaded from: output.jar:com/google/android/material/appbar/CollapsingToolbarLayout.class */
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/CollapsingToolbarLayout$LayoutParams.class */
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/CollapsingToolbarLayout$OffsetUpdateListener.class */
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/CollapsingToolbarLayout$TitleCollapseMode.class */
    ...
    */
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        int i3;
        int i4;
        ViewGroup viewGroup = this.toolbarDirectChild;
        if (viewGroup == null) {
            viewGroup = this.toolbar;
        }
        int maxOffsetForPinChild = getMaxOffsetForPinChild(viewGroup);
