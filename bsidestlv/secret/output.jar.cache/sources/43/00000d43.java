...
/* loaded from: output.jar:com/google/android/material/textfield/DropdownMenuEndIconDelegate.class */
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        if (boxBackgroundMode == 2) {
            ...
            addRippleEffectOnFilledLayout(autoCompleteTextView, color, r0, boxBackground);
        }
    }
