...
/* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/CurveFit.class */
public abstract class CurveFit {
    public static final int CONSTANT = 2;
    public static final int LINEAR = 1;
    public static final int SPLINE = 0;

    /* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/CurveFit$Constant.class */
