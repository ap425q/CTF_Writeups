...
/* loaded from: output.jar:androidx/appcompat/widget/AppCompatEditText.class */
public class AppCompatEditText extends EditText implements TintableBackgroundView, OnReceiveContentViewBehavior, EmojiCompatConfigurationView {
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/AppCompatEditText$InspectionCompanion.class */
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        InputConnection inputConnection = onCreateInputConnection2;
        if (onCreateInputConnection2 != null) {
            ...
            if (Build.VERSION.SDK_INT <= 30) {
                ...
                if (onReceiveContentMimeTypes != null) {
                    ...
                    inputConnection = InputConnectionCompat.createWrapper(this, onCreateInputConnection2, editorInfo);
                }
            }
        }
