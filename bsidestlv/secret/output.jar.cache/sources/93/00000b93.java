...
/* loaded from: output.jar:com/google/android/material/color/MaterialColors.class */
public class MaterialColors {
    ...
    public static ColorRoles getColorRoles(int i, boolean z) {
        return z ? new ColorRoles(getColorRole(i, 40), getColorRole(i, 100), getColorRole(i, TONE_ACCENT_CONTAINER_LIGHT), getColorRole(i, 10)) : new ColorRoles(getColorRole(i, TONE_ACCENT_DARK), getColorRole(i, 10), getColorRole(i, 20), getColorRole(i, TONE_ON_ACCENT_CONTAINER_DARK));
    }
