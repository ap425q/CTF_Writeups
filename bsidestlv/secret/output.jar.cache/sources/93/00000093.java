...
/* loaded from: output.jar:androidx/annotation/experimental/Experimental.class */
public @interface Experimental {
    ...
    /* loaded from: output.jar:androidx/annotation/experimental/Experimental$Level.class */
    public enum Level {
        WARNING,
        ERROR
    }
