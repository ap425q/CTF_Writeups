...
/* loaded from: output.jar:com/google/android/material/snackbar/SnackbarManager.class */
class SnackbarManager {
    ...
    /* loaded from: output.jar:com/google/android/material/snackbar/SnackbarManager$Callback.class */
    ...
    /* loaded from: output.jar:com/google/android/material/snackbar/SnackbarManager$SnackbarRecord.class */
    ...
    private void scheduleTimeoutLocked(SnackbarRecord snackbarRecord) {
        ...
        int i = snackbarRecord.duration > 0 ? snackbarRecord.duration : snackbarRecord.duration == -1 ? SHORT_DURATION_MS : LONG_DURATION_MS;
        this.handler.removeCallbacksAndMessages(snackbarRecord);
