...
/* loaded from: output.jar:androidx/concurrent/futures/CallbackToFutureAdapter.class */
public final class CallbackToFutureAdapter {

    /* loaded from: output.jar:androidx/concurrent/futures/CallbackToFutureAdapter$Completer.class */
    ...
    /* loaded from: output.jar:androidx/concurrent/futures/CallbackToFutureAdapter$FutureGarbageCollectedException.class */
    ...
    /* loaded from: output.jar:androidx/concurrent/futures/CallbackToFutureAdapter$Resolver.class */
    public interface Resolver<T> {
        Object attachCompleter(Completer<T> completer) throws Exception;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/concurrent/futures/CallbackToFutureAdapter$SafeFuture.class */
