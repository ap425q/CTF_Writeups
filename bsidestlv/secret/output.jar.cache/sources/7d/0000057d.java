...
/* loaded from: output.jar:androidx/core/provider/FontRequestWorker.class */
public class FontRequestWorker {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/core/provider/FontRequestWorker$TypefaceResult.class */
    ...
    public static Typeface requestFontAsync(final Context context, final FontRequest fontRequest, final int i, Executor executor, final CallbackWithHandler callbackWithHandler) {
        ...
        synchronized (LOCK) {
            ...
            RequestExecutor.execute(executorService, callable, new Consumer<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.4
                @Override // androidx.core.util.Consumer
                public void accept(TypefaceResult typefaceResult) {
