...
/* loaded from: output.jar:androidx/appcompat/widget/DrawableUtils.class */
public class DrawableUtils {
    private static final int[] CHECKED_STATE_SET = {16842912};
    private static final int[] EMPTY_STATE_SET = new int[0];
    public static final Rect INSETS_NONE = new Rect();

    /* loaded from: output.jar:androidx/appcompat/widget/DrawableUtils$Api18Impl.class */
    static class Api18Impl {
        ...
        static {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.DrawableUtils.Api18Impl.m38clinit():void");
        }
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/DrawableUtils$Api29Impl.class */
