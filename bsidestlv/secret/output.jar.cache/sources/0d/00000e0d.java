...
/* loaded from: output.jar:com/google/android/material/transition/platform/TransitionUtils.class */
class TransitionUtils {
    ...
    /* loaded from: output.jar:com/google/android/material/transition/platform/TransitionUtils$CanvasOperation.class */
    interface CanvasOperation {
        void run(Canvas canvas);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:com/google/android/material/transition/platform/TransitionUtils$CornerSizeBinaryOperator.class */
