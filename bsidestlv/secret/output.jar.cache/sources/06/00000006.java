...
/* loaded from: output.jar:android/support/v4/os/IResultReceiver.class */
public interface IResultReceiver extends IInterface {

    /* loaded from: output.jar:android/support/v4/os/IResultReceiver$Default.class */
    ...
    /* loaded from: output.jar:android/support/v4/os/IResultReceiver$Stub.class */
    public static abstract class Stub extends Binder implements IResultReceiver {
        private static final String DESCRIPTOR = "android.support.v4.os.IResultReceiver";
        static final int TRANSACTION_send = 1;

        /* JADX INFO: Access modifiers changed from: private */
        /* loaded from: output.jar:android/support/v4/os/IResultReceiver$Stub$Proxy.class */
