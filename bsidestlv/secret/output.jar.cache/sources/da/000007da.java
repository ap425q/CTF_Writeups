...
/* loaded from: output.jar:androidx/fragment/app/FragmentAnim.class */
public class FragmentAnim {

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/fragment/app/FragmentAnim$AnimationOrAnimator.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/fragment/app/FragmentAnim$EndViewTransitionAnimation.class */
    ...
    public static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z, boolean z2) {
        ...
        if (fragment.mContainer == null || fragment.mContainer.getLayoutTransition() == null) {
            ...
            if (nextAnim == 0) {
                i = nextAnim;
                if (nextTransition != 0) {
                    i = transitToAnimResourceId(nextTransition, z);
                }
            }
            if (i != 0) {
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        return i != 4097 ? i != 4099 ? i != 8194 ? -1 : z ? R.animator.fragment_close_enter : R.animator.fragment_close_exit : z ? R.animator.fragment_fade_enter : R.animator.fragment_fade_exit : z ? R.animator.fragment_open_enter : R.animator.fragment_open_exit;
    }
}