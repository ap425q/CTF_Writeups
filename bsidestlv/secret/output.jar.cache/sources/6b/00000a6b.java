...
/* loaded from: output.jar:androidx/versionedparcelable/VersionedParcel.class */
public abstract class VersionedParcel {
    ...
    /* loaded from: output.jar:androidx/versionedparcelable/VersionedParcel$ParcelException.class */
    ...
    private Method getReadMethod(String str) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        if (method == null) {
            ...
            this.mReadCache.put(str, method2);
        }
        return method2;
    }
    ...
    private Method getWriteMethod(Class cls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        if (method == null) {
            ...
            System.currentTimeMillis();
            method2 = findParcelClass.getDeclaredMethod("write", cls, VersionedParcel.class);
            this.mWriteCache.put(cls.getName(), method2);
        }
        return method2;
    }
    ...
    public void writeException(Exception exc, int i) {
        ...
        int i2 = ((exc instanceof Parcelable) && exc.getClass().getClassLoader() == Parcelable.class.getClassLoader()) ? EX_PARCELABLE : exc instanceof SecurityException ? -1 : exc instanceof BadParcelableException ? -2 : exc instanceof IllegalArgumentException ? -3 : exc instanceof NullPointerException ? -4 : exc instanceof IllegalStateException ? EX_ILLEGAL_STATE : exc instanceof NetworkOnMainThreadException ? EX_NETWORK_MAIN_THREAD : exc instanceof UnsupportedOperationException ? EX_UNSUPPORTED_OPERATION : 0;
        writeInt(i2);
        if (i2 == 0) {
