...
/* loaded from: output.jar:androidx/appcompat/widget/ActionMenuView.class */
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/ActionMenuView$ActionMenuChildView.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/ActionMenuView$ActionMenuPresenterCallback.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/ActionMenuView$LayoutParams.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/appcompat/widget/ActionMenuView$MenuBuilderCallback.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/ActionMenuView$OnMenuItemClickListener.class */
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i14 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int measureChildForCells = measureChildForCells(childAt, i10, layoutParams.isOverflowButton ? 1 : i16, childMeasureSpec, paddingTop);
        ...
        while (i11 > 0 && i18 > 0) {
            ...
            for (int i22 = 0; i22 < childCount; i22++) {
                ...
                if ((j & j5) == 0) {
                    ...
                    if (z7 && layoutParams3.preventEdgeOffset && i18 == 1) {
        ...
        i3 = i15;
        boolean z8 = !z4 && i13 == 1;
        if (i18 > 0 && j3 != 0 && (i18 < i13 - 1 || z8 || i12 > 1)) {
            ...
            int i25 = bitCount > 0.0f ? (int) ((i18 * i10) / bitCount) : 0;
            int i26 = 0;
            while (true) {
                z2 = z;
                if (i26 >= childCount) {
