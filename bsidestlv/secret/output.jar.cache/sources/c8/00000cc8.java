...
/* loaded from: output.jar:com/google/android/material/shape/ShapeAppearancePathProvider.class */
public class ShapeAppearancePathProvider {
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapeAppearancePathProvider$Lazy.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapeAppearancePathProvider$PathListener.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapeAppearancePathProvider$ShapeAppearancePathSpec.class */
    ...
    public void calculatePath(ShapeAppearanceModel shapeAppearanceModel, float f, RectF rectF, PathListener pathListener, Path path) {
        ...
        for (i = 0; i < 4; i++) {
            appendCornerPath(shapeAppearancePathSpec, i);
            appendEdgePath(shapeAppearancePathSpec, i);
        }
        path.close();
