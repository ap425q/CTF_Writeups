...
/* loaded from: output.jar:androidx/viewpager/widget/ViewPager.class */
public class ViewPager extends ViewGroup {
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$DecorView.class */
    public @interface DecorView {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$ItemInfo.class */
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$LayoutParams.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$MyAccessibilityDelegate.class */
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        MyAccessibilityDelegate() {
        }

        /* JADX WARN: Code restructure failed: missing block: B:5:0x0019, code lost:
            if (r3.this$0.mAdapter.getCount() > 1) goto L5;
         */
        /*
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$OnAdapterChangeListener.class */
    public interface OnAdapterChangeListener {
        void onAdapterChanged(ViewPager viewPager, PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }

    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$OnPageChangeListener.class */
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$PageTransformer.class */
    public interface PageTransformer {
        void transformPage(View view, float f);
    }

    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$PagerObserver.class */
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$SavedState.class */
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$SimpleOnPageChangeListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/viewpager/widget/ViewPager$ViewPositionComparator.class */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00a3, code lost:
        if (r13.position == r6.mCurItem) goto L28;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        int min = Math.min(abs2 > 0 ? Math.round(Math.abs((f2 + (distanceInfluenceForSnapDuration * f2)) / abs2) * 1000.0f) * 4 : (int) (((Math.abs(i4) / ((f * this.mAdapter.getPageWidth(this.mCurItem)) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
