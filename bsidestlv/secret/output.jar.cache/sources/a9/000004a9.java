...
/* loaded from: output.jar:androidx/core/content/FileProvider.class */
public class FileProvider extends ContentProvider {
    ...
    /* loaded from: output.jar:androidx/core/content/FileProvider$PathStrategy.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/core/content/FileProvider$SimplePathStrategy.class */
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(entry.getValue().getPath().endsWith("/") ? canonicalPath.substring(path.length()) : canonicalPath.substring(path.length() + 1), "/")).build();
                }
