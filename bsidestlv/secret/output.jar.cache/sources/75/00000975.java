...
/* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager.class */
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager$AnchorInfo.class */
    ...
    /* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager$LayoutParams.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager$LazySpanLookup.class */
    public static class LazySpanLookup {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem.class */
    ...
    /* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager$SavedState.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/recyclerview/widget/StaggeredGridLayoutManager$Span.class */
    public class Span {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i4 = this.mLayoutState.mInfinite ? layoutState.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
        ...
        while (true) {
            ...
            boolean z4 = span2 == -1 ? true : z2;
            if (z4) {
                span = layoutParams.mFullSpan ? this.mSpans[z2 ? 1 : 0] : getNextSpan(layoutState);
            ...
            if (layoutState.mLayoutDirection == 1) {
                ...
                int decoratedMeasurement2 = this.mPrimaryOrientation.getDecoratedMeasurement(next);
                ...
                i = decoratedMeasurement2 + maxEnd;
            ...
            if (isLayoutRTL() && this.mOrientation == 1) {
                ...
                int decoratedMeasurement3 = this.mSecondaryOrientation.getDecoratedMeasurement(next);
                int i5 = startAfterPadding;
                i2 = decoratedMeasurement3 + startAfterPadding;
                i3 = i5;
            }
            if (this.mOrientation == 1) {
                layoutDecoratedWithMargins(next, i3, decoratedMeasurement, i2, i);
            } else {
                layoutDecoratedWithMargins(next, decoratedMeasurement, i3, i, i2);
            }
            if (layoutParams.mFullSpan) {
                updateAllRemainingSpans(this.mLayoutState.mLayoutDirection, i4);
            } else {
                updateRemainingSpans(span, this.mLayoutState.mLayoutDirection, i4);
            }
        ...
        if (startAfterPadding2 > 0) {
            z2 = Math.min(layoutState.mAvailable, startAfterPadding2);
        }
        return z2 ? 1 : 0;
    }
    ...
    public void collectAdjacentPrefetchPositions(int i, int i2, RecyclerView.State state, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        while (true) {
            ...
            if (this.mLayoutState.mItemDirection == -1) {
                ...
                i4 = this.mSpans[i5].getStartLine(this.mLayoutState.mStartLine);
            } else {
        ...
        for (int i9 = 0; i9 < i3 && this.mLayoutState.hasMore(state); i9++) {
    ...
    */
    ...
    public void setMeasuredDimension(Rect rect, int i, int i2) {
        ...
        if (this.mOrientation == 1) {
            ...
            int chooseSize2 = chooseSize(i, (this.mSizePerSpan * this.mSpanCount) + paddingLeft, getMinimumWidth());
            i4 = chooseSize;
            i3 = chooseSize2;
        } else {
            int chooseSize3 = chooseSize(i, rect.width() + paddingLeft, getMinimumWidth());
            int chooseSize4 = chooseSize(i2, (this.mSizePerSpan * this.mSpanCount) + paddingTop, getMinimumHeight());
            i3 = chooseSize3;
            i4 = chooseSize4;
        }
