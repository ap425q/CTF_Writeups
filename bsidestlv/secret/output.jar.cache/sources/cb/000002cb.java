...
/* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/SplineSet.class */
public abstract class SplineSet {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/SplineSet$CoreSpline.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/SplineSet$CustomSet.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/SplineSet$CustomSpline.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/motion/utils/SplineSet$Sort.class */
    ...
    public void setup(int i) {
        ...
        for (i3 = 0; i3 < this.count; i3 = i3 + 1) {
            ...
            dArr[i8] = this.mTimePoints[i3] * 0.01d;
            dArr2[i8][0] = this.mValues[i3];
            i8++;
        }
        this.mCurveFit = CurveFit.get(i, dArr, dArr2);
    }
