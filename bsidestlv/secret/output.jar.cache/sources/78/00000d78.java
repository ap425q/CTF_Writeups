...
/* loaded from: output.jar:com/google/android/material/timepicker/MaterialTimePicker.class */
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    /* loaded from: output.jar:com/google/android/material/timepicker/MaterialTimePicker$Builder.class */
    ...
    private int getThemeResId() {
        ...
        return resolve == null ? 0 : resolve.data;
    }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i, TimePickerView timePickerView, ViewStub viewStub) {
        ...
        if (timePickerClockPresenter == null) {
            timePickerClockPresenter2 = new TimePickerClockPresenter(timePickerView, this.time);
        }
