...
/* loaded from: output.jar:androidx/transition/TransitionSet.class */
public class TransitionSet extends Transition {
    ...
    /* loaded from: output.jar:androidx/transition/TransitionSet$TransitionSetListener.class */
    ...
    public Transition mo359clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo359clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo359clone());
        }
