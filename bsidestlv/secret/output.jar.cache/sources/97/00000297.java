...
/* loaded from: output.jar:androidx/constraintlayout/core/SolverVariableValues.class */
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public void put(SolverVariable solverVariable, float f) {
        ...
        while (true) {
            ...
            if (i2 >= i3) {
                break;
            } else if (this.variables[i4] == solverVariable.id) {
                this.values[i4] = f;
                return;
            } else {
                if (this.variables[i4] < solverVariable.id) {
                    i5 = i4;
                }
                i4 = this.next[i4];
                if (i4 == -1) {
        ...
        insertVariable(i, solverVariable, f);
    }
