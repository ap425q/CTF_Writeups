...
/* loaded from: output.jar:com/google/android/material/shape/ShapeAppearanceModel.class */
public class ShapeAppearanceModel {
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapeAppearanceModel$Builder.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapeAppearanceModel$CornerSizeUnaryOperator.class */
    ...
    private static Builder builder(Context context, int i, int i2, CornerSize cornerSize) {
        ...
        TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(i3, R.styleable.ShapeAppearance);
        try {
