...
/* loaded from: output.jar:androidx/constraintlayout/utils/widget/MockView.class */
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float width2 = (i - this.mTextBounds.width()) / 2.0f;
        float height2 = ((i2 - this.mTextBounds.height()) / 2.0f) + this.mTextBounds.height();
