...
/* loaded from: output.jar:androidx/constraintlayout/helper/widget/CircularFlow.class */
public class CircularFlow extends VirtualLayout {
    ...
    private float[] removeAngle(float[] fArr, int i) {
        ...
        if (fArr != null) {
            fArr2 = fArr;
            if (i >= 0) {
                fArr2 = i >= this.mCountAngle ? fArr : removeElementFromArray(fArr, i);
            }
        }
        return fArr2;
    }
    ...
    private int[] removeRadius(int[] iArr, int i) {
        ...
        if (iArr != null) {
            iArr2 = iArr;
            if (i >= 0) {
                iArr2 = i >= this.mCountRadius ? iArr : removeElementFromArray(iArr, i);
            }
        }
        return iArr2;
    }
