...
/* loaded from: output.jar:androidx/dynamicanimation/animation/DynamicAnimation.class */
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* loaded from: output.jar:androidx/dynamicanimation/animation/DynamicAnimation$MassState.class */
    static class MassState {
        float mValue;
        float mVelocity;
    }

    /* loaded from: output.jar:androidx/dynamicanimation/animation/DynamicAnimation$OnAnimationEndListener.class */
    public interface OnAnimationEndListener {
        void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2);
    }

    /* loaded from: output.jar:androidx/dynamicanimation/animation/DynamicAnimation$OnAnimationUpdateListener.class */
    public interface OnAnimationUpdateListener {
        void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f, float f2);
    }

    /* loaded from: output.jar:androidx/dynamicanimation/animation/DynamicAnimation$ViewProperty.class */
