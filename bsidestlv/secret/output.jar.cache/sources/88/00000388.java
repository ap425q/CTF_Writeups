...
/* loaded from: output.jar:androidx/constraintlayout/motion/widget/DesignTool.class */
public class DesignTool implements ProxyInterface {
    ...
    public int designAccess(int i, String str, Object obj, float[] fArr, int i2, float[] fArr2, int i3) {
        ...
        } else if (this.mMotionLayout.mScene == null || view == null) {
            return -1;
        } else {
    ...
    public void setState(String str) {
        ...
        if (this.mLastStartState == str2) {
            return;
        }
        this.mLastStartState = str2;
        this.mLastEndState = null;
        if (this.mMotionLayout.mScene == null) {
            this.mMotionLayout.mScene = this.mSceneCache;
        }
        int lookUpConstraintId = this.mMotionLayout.lookUpConstraintId(str2);
