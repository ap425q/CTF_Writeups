...
/* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout.class */
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$5.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$DecelerateInterpolator.class */
    class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float f) {
            ...
            if (f4 > 0.0f) {
                ...
                MotionLayout.this.mLastVelocity = f4 - (f5 * f6);
                f2 = (this.initalV * f6) - (((this.maxA * f6) * f6) / 2.0f);
                f3 = this.currentP;
            } else {
                float f7 = -f4;
                float f8 = this.maxA;
                ...
                MotionLayout.this.mLastVelocity = f4 + (f8 * f9);
                f2 = (this.initalV * f9) + (((this.maxA * f9) * f9) / 2.0f);
                f3 = this.currentP;
            }
            return f2 + f3;
        }
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw.class */
            ...
            for (MotionController motionController : hashMap.values()) {
                ...
                if (i3 != 0) {
                    ...
                    if (i3 >= 1) {
                        ...
                        drawAll(canvas, i3, this.mKeyFrameCount, motionController);
                        this.mPaint.setColor(-21965);
                        this.mPaintKeyframes.setColor(-2067046);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$Model.class */
    public class Model {
        int mEndId;
        int mStartId;
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (view instanceof TextView) {
                    str5 = name + "(" + ((Object) ((TextView) view).getText()) + ")";
                }
                Log.v(MotionLayout.TAG, str3 + "  " + str5 + " " + constraintWidget + " " + str4);
            }
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintWidget.mBottom.mTarget != null) {
                str3 = "B".concat(constraintWidget.mBottom.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B");
            } else {
                str3 = "__";
            }
            ...
            if (constraintWidget.mRight.mTarget != null) {
                str5 = "R".concat(constraintWidget.mRight.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            }
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$MotionTracker.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$MyTracker.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$StateCache.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$TransitionListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/MotionLayout$TransitionState.class */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00e5, code lost:
        if (r12 <= r7.mTransitionGoalPosition) goto L24;
     */
    ...
    */
    ...
    public void setupMotionViews() {
        ...
        if (this.mDecoratorsHelpers != null) {
            for (int i8 = 0; i8 < i; i8++) {
                MotionController motionController3 = this.mFrameArrayList.get(findViewById(iArr[i8]));
        ...
        if (staggered != 0.0f) {
            ...
            if (!z) {
                for (int i13 = 0; i13 < childCount; i13++) {
                    ...
                    motionController8.mStaggerOffset = abs - (((f4 - f2) * abs) / (f - f2));
                }
                return;
            }
            int i14 = 0;
            ...
            while (true) {
                ...
                if (!Float.isNaN(motionController9.mMotionStagger)) {
                    f8 = Math.min(f5, motionController9.mMotionStagger);
                    f7 = Math.max(f6, motionController9.mMotionStagger);
                }
                i14++;
                f6 = f7;
                f5 = f8;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void evaluate(boolean r9) {
        /*
    ...
    public void getViewVelocity(View view, float f, float f2, float[] fArr, int i) {
        ...
        if (this.mInterpolator != null) {
            ...
            f3 = (signum * ((interpolation - f4) / EPSILON)) / this.mTransitionDuration;
        }
    ...
    public void rotateTo(int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (viewState == null) {
                ...
                this.mPreRotate.put(childAt, viewState2);
            }
    ...
    public void setTransition(int i) {
        if (this.mScene != null) {
            ...
            int i2 = this.mCurrentState;
            float f = 0.0f;
            float f2 = i2 == this.mBeginState ? 0.0f : i2 == this.mEndState ? 1.0f : Float.NaN;
    ...
    public void transitionToState(int i, int i2, int i3, int i4) {
        ...
        if (motionScene != null) {
            ...
            if (motionScene.mStateSet != null) {
                int convertToConstraintSet = this.mScene.mStateSet.convertToConstraintSet(this.mCurrentState, i, i2, i3);
                i6 = i;
        ...
        if (this.mBeginState == i6) {
            ...
            this.mInTransition = true;
            this.mModel.initFrom(this.mLayoutWidget, null, this.mScene.getConstraintSet(i6));
            rebuildScene();
            this.mModel.build();
