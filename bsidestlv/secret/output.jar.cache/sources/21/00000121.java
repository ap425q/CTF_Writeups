...
/* loaded from: output.jar:androidx/appcompat/view/SupportActionModeWrapper.class */
public class SupportActionModeWrapper extends android.view.ActionMode {
    final Context mContext;
    final ActionMode mWrappedObject;

    /* loaded from: output.jar:androidx/appcompat/view/SupportActionModeWrapper$CallbackWrapper.class */
    public static class CallbackWrapper implements ActionMode.Callback {
        ...
        private Menu getMenuWrapper(Menu menu) {
            ...
            if (menu2 == null) {
                menuWrapperICS = new MenuWrapperICS(this.mContext, (SupportMenu) menu);
