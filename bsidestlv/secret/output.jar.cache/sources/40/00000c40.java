...
/* loaded from: output.jar:com/google/android/material/internal/StaticLayoutBuilderCompat.class */
final class StaticLayoutBuilderCompat {
    ...
    /* loaded from: output.jar:com/google/android/material/internal/StaticLayoutBuilderCompat$StaticLayoutBuilderCompatException.class */
    ...
    public StaticLayout build() throws StaticLayoutBuilderCompatException {
        ...
        if (this.maxLines == 1) {
            charSequence2 = TextUtils.ellipsize(charSequence, this.paint, max, this.ellipsize);
        }
        this.end = Math.min(charSequence2.length(), this.end);
        if (this.isRtl && this.maxLines == 1) {
            this.alignment = Layout.Alignment.ALIGN_OPPOSITE;
        }
        StaticLayout.Builder obtain = StaticLayout.Builder.obtain(charSequence2, this.start, this.end, this.paint, max);
