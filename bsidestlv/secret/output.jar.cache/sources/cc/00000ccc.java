...
/* loaded from: output.jar:com/google/android/material/shape/ShapePath.class */
public class ShapePath {
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$ArcShadowOperation.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$LineShadowOperation.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$PathArcOperation.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$PathCubicOperation.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$PathLineOperation.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$PathOperation.class */
    ...
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$PathQuadOperation.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:com/google/android/material/shape/ShapePath$ShadowCompatOperation.class */
    ...
    public void addArc(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float f8 = f5;
        if (z) {
            f8 = (f5 + ANGLE_LEFT) % 360.0f;
        }
        addShadowCompatOperation(arcShadowOperation, f8, z ? (ANGLE_LEFT + f7) % 360.0f : f7);
        double d = f7;
