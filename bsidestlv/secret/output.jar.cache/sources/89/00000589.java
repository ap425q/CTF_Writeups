...
/* loaded from: output.jar:androidx/core/provider/RequestExecutor.class */
class RequestExecutor {

    /* loaded from: output.jar:androidx/core/provider/RequestExecutor$DefaultThreadFactory.class */
    private static class DefaultThreadFactory implements ThreadFactory {
        private int mPriority;
        private String mThreadName;

        /* loaded from: output.jar:androidx/core/provider/RequestExecutor$DefaultThreadFactory$ProcessPriorityThread.class */
    ...
    /* loaded from: output.jar:androidx/core/provider/RequestExecutor$HandlerExecutor.class */
    ...
    /* loaded from: output.jar:androidx/core/provider/RequestExecutor$ReplyRunnable.class */
