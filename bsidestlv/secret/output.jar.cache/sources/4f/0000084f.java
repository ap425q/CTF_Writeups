...
@Deprecated
/* loaded from: output.jar:androidx/lifecycle/ClassesInfoCache.class */
final class ClassesInfoCache {
    ...
    @Deprecated
    /* loaded from: output.jar:androidx/lifecycle/ClassesInfoCache$CallbackInfo.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Deprecated
    /* loaded from: output.jar:androidx/lifecycle/ClassesInfoCache$MethodReference.class */
