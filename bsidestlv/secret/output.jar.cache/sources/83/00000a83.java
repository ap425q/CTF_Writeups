...
@ViewPager.DecorView
/* loaded from: output.jar:androidx/viewpager/widget/PagerTitleStrip.class */
public class PagerTitleStrip extends ViewGroup {
    ...
    /* loaded from: output.jar:androidx/viewpager/widget/PagerTitleStrip$PageListener.class */
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onPageScrolled(int i, float f, int i2) {
            ...
            PagerTitleStrip.this.updateTextPositions(i3, f, false);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/viewpager/widget/PagerTitleStrip$SingleLineAllCapsTransform.class */
