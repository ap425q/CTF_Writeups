...
/* loaded from: output.jar:com/google/android/material/progressindicator/CircularIndeterminateAnimatorDelegate.class */
    ...
    private void maybeUpdateSegmentColors(int i) {
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            if (fractionInRange >= 0.0f && fractionInRange <= 1.0f) {
                ...
                this.segmentColors[0] = ArgbEvaluatorCompat.getInstance().evaluate(this.interpolator.getInterpolation(fractionInRange), Integer.valueOf(MaterialColors.compositeARGBWithAlpha(this.baseSpec.indicatorColors[length], this.drawable.getAlpha())), Integer.valueOf(MaterialColors.compositeARGBWithAlpha(this.baseSpec.indicatorColors[(length + 1) % length2], this.drawable.getAlpha()))).intValue();
                return;
            }
        }
    }
