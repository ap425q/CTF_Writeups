...
/* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform.class */
public final class MaterialContainerTransform extends Transition {
    ...
    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform$FadeMode.class */
    public @interface FadeMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform$FitMode.class */
    public @interface FitMode {
    }

    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform$ProgressThresholds.class */
    ...
    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform$ProgressThresholdsGroup.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform$TransitionDirection.class */
    public @interface TransitionDirection {
    }

    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransform$TransitionDrawable.class */
    private static final class TransitionDrawable extends Drawable {
        ...
        */
        private void updateProgress(float r10) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable.updateProgress(float):void");
        }
