...
/* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout.class */
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$AttachedBehavior.class */
    public interface AttachedBehavior {
        Behavior getBehavior();
    }

    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$Behavior.class */
    ...
    @Deprecated
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$DefaultBehavior.class */
    public @interface DefaultBehavior {
        Class<? extends Behavior> value();
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$DispatchChangeEvent.class */
    public @interface DispatchChangeEvent {
    }

    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$HierarchyChangeListener.class */
    ...
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$LayoutParams.class */
    ...
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$OnPreDrawListener.class */
    ...
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$SavedState.class */
    ...
    /* loaded from: output.jar:androidx/coordinatorlayout/widget/CoordinatorLayout$ViewElevationComparator.class */
    ...
    private boolean performIntercept(MotionEvent motionEvent, int i) {
        ...
        while (true) {
            ...
            if ((z4 || z6) && actionMasked != 0) {
                ...
                boolean z8 = isBlockingInteractionBelow && !didBlockInteraction;
                motionEvent2 = motionEvent3;
                z2 = z7;
                z3 = z8;
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i3)) {
                    ...
                    if (behavior != null) {
                        ...
                        i4 = i > 0 ? Math.max(i7, iArr3[0]) : Math.min(i7, iArr3[0]);
                        int[] iArr4 = this.mBehaviorConsumed;
                        i5 = i2 > 0 ? Math.max(i6, iArr4[1]) : Math.min(i6, iArr4[1]);
                        z = true;
                    }
                } else {
                    i4 = i7;
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i5)) {
                    ...
                    if (behavior != null) {
                        ...
                        int[] iArr3 = this.mBehaviorConsumed;
                        int max = i3 > 0 ? Math.max(i9, iArr3[0]) : Math.min(i9, iArr3[0]);
