...
/* loaded from: output.jar:androidx/appcompat/widget/SearchView.class */
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$InspectionCompanion.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$OnCloseListener.class */
    public interface OnCloseListener {
        boolean onClose();
    }

    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$OnQueryTextListener.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$OnSuggestionListener.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$PreQAutoCompleteTextViewReflector.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$SavedState.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$SearchAutoComplete.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/SearchView$UpdatableTouchDelegate.class */
    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            min = i3 > 0 ? Math.min(i3, size) : Math.min(getPreferredWidth(), size);
        } else if (mode == 0) {
            min = this.mMaxWidth;
            if (min <= 0) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(min, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(size2, BasicMeasure.EXACTLY));
    }
