...
/* loaded from: output.jar:androidx/constraintlayout/widget/SharedValues.class */
public class SharedValues {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/widget/SharedValues$SharedValuesListener.class */
    ...
    public void addListener(int i, SharedValuesListener sharedValuesListener) {
        ...
        if (hashSet == null) {
            ...
            this.mValuesListeners.put(Integer.valueOf(i), hashSet2);
        }
