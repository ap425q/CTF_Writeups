...
/* loaded from: output.jar:androidx/constraintlayout/core/state/ConstraintReference.class */
public class ConstraintReference implements Reference {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/ConstraintReference$1.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/ConstraintReference$ConstraintReferenceFactory.class */
    public interface ConstraintReferenceFactory {
        ConstraintReference create(State state);
    }

    /* loaded from: output.jar:androidx/constraintlayout/core/state/ConstraintReference$IncorrectConstraintException.class */
    ...
    private Object get(Object obj) {
        ...
        if (!(obj instanceof ConstraintReference)) {
            reference = this.mState.reference(obj);
        }
        return reference;
    }
