...
/* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout.class */
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$BaseBehavior.class */
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$BaseBehavior$BaseDragCallback.class */
        public static abstract class BaseDragCallback<T extends AppBarLayout> {
            public abstract boolean canDrag(T t);
        }

        /* JADX INFO: Access modifiers changed from: protected */
        /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$BaseBehavior$SavedState.class */
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$BaseOnOffsetChangedListener.class */
    public interface BaseOnOffsetChangedListener<T extends AppBarLayout> {
        void onOffsetChanged(T t, int i);
    }

    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$Behavior.class */
    public static class Behavior extends BaseBehavior<AppBarLayout> {

        /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$Behavior$DragCallback.class */
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$ChildScrollEffect.class */
    public static abstract class ChildScrollEffect {
        public abstract void onOffsetChanged(AppBarLayout appBarLayout, View view, float f);
    }

    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$CompressChildScrollEffect.class */
    public static class CompressChildScrollEffect extends ChildScrollEffect {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, View view, float f) {
            ...
            float f2 = -abs;
            float f3 = 1.0f - clamp;
            float height = f2 - ((this.relativeRect.height() * COMPRESS_DISTANCE_FACTOR) * (1.0f - (f3 * f3)));
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$LayoutParams.class */
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$LayoutParams$ScrollFlags.class */
    ...
    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$LiftOnScrollListener.class */
    public interface LiftOnScrollListener {
        void onUpdate(float f, int i);
    }

    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$OnOffsetChangedListener.class */
    public interface OnOffsetChangedListener extends BaseOnOffsetChangedListener<AppBarLayout> {
        @Override // com.google.android.material.appbar.AppBarLayout.BaseOnOffsetChangedListener
        void onOffsetChanged(AppBarLayout appBarLayout, int i);
    }

    /* loaded from: output.jar:com/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior.class */
    ...
    */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        setLiftableState(this.liftOnScroll ? true : hasCollapsibleChild());
    }
