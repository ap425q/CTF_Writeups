...
/* loaded from: output.jar:com/google/android/material/navigation/NavigationBarView.class */
public abstract class NavigationBarView extends FrameLayout {
    ...
    /* loaded from: output.jar:com/google/android/material/navigation/NavigationBarView$LabelVisibility.class */
    public @interface LabelVisibility {
    }

    /* loaded from: output.jar:com/google/android/material/navigation/NavigationBarView$OnItemReselectedListener.class */
    public interface OnItemReselectedListener {
        void onNavigationItemReselected(MenuItem menuItem);
    }

    /* loaded from: output.jar:com/google/android/material/navigation/NavigationBarView$OnItemSelectedListener.class */
    public interface OnItemSelectedListener {
        boolean onNavigationItemSelected(MenuItem menuItem);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:com/google/android/material/navigation/NavigationBarView$SavedState.class */
