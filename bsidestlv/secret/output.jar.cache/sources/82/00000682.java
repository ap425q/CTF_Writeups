...
/* loaded from: output.jar:androidx/core/view/inputmethod/InputConnectionCompat.class */
public final class InputConnectionCompat {
    ...
    /* loaded from: output.jar:androidx/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener.class */
                ...
                if (Build.VERSION.SDK_INT >= 25) {
                    ...
                    if ((i & 1) != 0) {
                        try {
                            ...
                            bundle3.putParcelable(InputConnectionCompat.EXTRA_INPUT_CONTENT_INFO, inputContentInfo);
                            bundle2 = bundle3;
                        } catch (Exception e) {
    ...
    static boolean handlePerformPrivateCommand(String str, Bundle bundle, OnCommitContentListener onCommitContentListener) {
        ...
        try {
            ResultReceiver resultReceiver2 = (ResultReceiver) bundle.getParcelable(b != 0 ? COMMIT_CONTENT_RESULT_INTEROP_RECEIVER_KEY : COMMIT_CONTENT_RESULT_RECEIVER_KEY);
            try {
                Uri uri = (Uri) bundle.getParcelable(b != 0 ? COMMIT_CONTENT_CONTENT_URI_INTEROP_KEY : COMMIT_CONTENT_CONTENT_URI_KEY);
                ClipDescription clipDescription = (ClipDescription) bundle.getParcelable(b != 0 ? COMMIT_CONTENT_DESCRIPTION_INTEROP_KEY : COMMIT_CONTENT_DESCRIPTION_KEY);
                Uri uri2 = (Uri) bundle.getParcelable(b != 0 ? COMMIT_CONTENT_LINK_URI_INTEROP_KEY : COMMIT_CONTENT_LINK_URI_KEY);
                int i = bundle.getInt(b != 0 ? COMMIT_CONTENT_FLAGS_INTEROP_KEY : COMMIT_CONTENT_FLAGS_KEY);
                Bundle bundle2 = (Bundle) bundle.getParcelable(b != 0 ? COMMIT_CONTENT_OPTS_INTEROP_KEY : COMMIT_CONTENT_OPTS_KEY);
                boolean z = false;
                if (uri != null) {
                    z = false;
