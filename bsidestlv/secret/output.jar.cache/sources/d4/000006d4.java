...
/* loaded from: output.jar:androidx/customview/widget/ViewDragHelper.class */
public class ViewDragHelper {
    ...
    /* loaded from: output.jar:androidx/customview/widget/ViewDragHelper$Callback.class */
    ...
    private void reportNewEdgeDrags(float f, float f2, int i) {
        ...
        if (z3) {
            ...
            iArr[i] = iArr[i] | z3;
            this.mCallback.onEdgeDragStarted(z3 ? 1 : 0, i);
        }
    }
