...
/* loaded from: output.jar:com/google/android/material/divider/MaterialDividerItemDecoration.class */
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawForHorizontalOrientation(Canvas canvas, RecyclerView recyclerView) {
        ...
        int i2 = this.insetStart;
        int i3 = this.insetEnd;
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            this.dividerDrawable.setBounds((round - this.dividerDrawable.getIntrinsicWidth()) - this.thickness, i + i2, round, height - i3);
    ...
    private void drawForVerticalOrientation(Canvas canvas, RecyclerView recyclerView) {
        ...
        int i3 = z ? this.insetStart : this.insetEnd;
        int childCount = recyclerView.getChildCount();
        for (int i4 = 0; i4 < childCount; i4++) {
            View childAt = recyclerView.getChildAt(i4);
            ...
            this.dividerDrawable.setBounds(i + i2, (round - this.dividerDrawable.getIntrinsicHeight()) - this.thickness, width - i3, round);
            this.dividerDrawable.draw(canvas);
        }
        canvas.restore();
    }
