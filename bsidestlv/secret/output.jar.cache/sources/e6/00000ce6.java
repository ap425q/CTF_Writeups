...
/* loaded from: output.jar:com/google/android/material/slider/RangeSlider.class */
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    private float minSeparation;
    private int separationUnit;

    /* loaded from: output.jar:com/google/android/material/slider/RangeSlider$OnChangeListener.class */
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
    }

    /* loaded from: output.jar:com/google/android/material/slider/RangeSlider$OnSliderTouchListener.class */
    public interface OnSliderTouchListener extends BaseOnSliderTouchListener<RangeSlider> {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:com/google/android/material/slider/RangeSlider$RangeSliderState.class */
