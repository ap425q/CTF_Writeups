...
/* loaded from: output.jar:androidx/constraintlayout/core/state/State.class */
public class State {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/State$1.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/State$Chain.class */
    public enum Chain {
        SPREAD,
        SPREAD_INSIDE,
        PACKED
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/State$Constraint.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/State$Direction.class */
    ...
    /* loaded from: output.jar:androidx/constraintlayout/core/state/State$Helper.class */
    public enum Helper {
        HORIZONTAL_CHAIN,
        VERTICAL_CHAIN,
        ALIGN_HORIZONTALLY,
    ...
    /* JADX WARN: Type inference failed for: r0v147, types: [androidx.constraintlayout.core.state.Reference] */
    /* JADX WARN: Type inference failed for: r0v164, types: [androidx.constraintlayout.core.state.Reference] */
    ...
    public void setTag(String str, String str2) {
        ...
        if (constraints instanceof ConstraintReference) {
            ...
            if (this.mTags.containsKey(str2)) {
                ...
                this.mTags.put(str2, arrayList2);
