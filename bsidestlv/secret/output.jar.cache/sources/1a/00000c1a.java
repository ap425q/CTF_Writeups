...
/* loaded from: output.jar:com/google/android/material/internal/CollapsingTextHelper.class */
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        if (staticLayout4 != null) {
            f2 = measureText;
            if (this.maxLines > 1) {
                f2 = staticLayout4.getWidth();
            }
        }
        StaticLayout staticLayout5 = this.textLayout;
        float f3 = 0.0f;
        if (staticLayout5 != null) {
            f3 = this.maxLines > 1 ? staticLayout5.getLineStart(0) : staticLayout5.getLineLeft(0);
        }
