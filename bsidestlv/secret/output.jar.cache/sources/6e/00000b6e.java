...
/* loaded from: output.jar:com/google/android/material/chip/ChipDrawable.class */
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    /* loaded from: output.jar:com/google/android/material/chip/ChipDrawable$Delegate.class */
    ...
    public static ChipDrawable createFromResource(Context context, int i) {
        ...
        if (styleAttribute == 0) {
            i2 = R.style.Widget_MaterialComponents_Chip_Entry;
        }
        return createFromAttributes(context, parseDrawableXml, R.attr.chipStandaloneStyle, i2);
    }
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        boolean z5 = hasState(getState(), 16842912) && this.checkable;
        if (this.currentChecked == z5 || this.checkedIcon == null) {
            z = false;
        } else {
            float calculateChipIconWidth = calculateChipIconWidth();
            this.currentChecked = z5;
        ...
        if (isStateful(this.chipIcon)) {
            z6 = z2 | this.chipIcon.setState(iArr);
        }
        boolean z7 = z6;
        if (isStateful(this.checkedIcon)) {
            z7 = z6 | this.checkedIcon.setState(iArr);
        }
        boolean z8 = z7;
        if (isStateful(this.closeIcon)) {
            ...
            z8 = z7 | this.closeIcon.setState(iArr3);
        }
        boolean z9 = z8;
        if (RippleUtils.USE_FRAMEWORK_RIPPLE) {
            z9 = z8;
            if (isStateful(this.closeIconRipple)) {
                z9 = z8 | this.closeIconRipple.setState(iArr2);
            }
        }
        if (z9) {
            invalidateSelf();
    ...
    public boolean onLayoutDirectionChanged(int i) {
        ...
        if (showsChipIcon()) {
            z = onLayoutDirectionChanged | DrawableCompat.setLayoutDirection(this.chipIcon, i);
        }
        boolean z2 = z;
        if (showsCheckedIcon()) {
            z2 = z | DrawableCompat.setLayoutDirection(this.checkedIcon, i);
        }
        boolean z3 = z2;
        if (showsCloseIcon()) {
            z3 = z2 | DrawableCompat.setLayoutDirection(this.closeIcon, i);
        }
        if (z3) {
            invalidateSelf();
            return true;
