...
/* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback.class */
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback$ShapeProvider.class */
    public interface ShapeProvider {
        ShapeAppearanceModel provideShape(View view);
    }

    /* loaded from: output.jar:com/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback$ShapeableViewShapeProvider.class */
