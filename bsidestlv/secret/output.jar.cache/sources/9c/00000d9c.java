...
@Deprecated
/* loaded from: output.jar:com/google/android/material/transformation/FabTransformationBehavior.class */
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    /* loaded from: output.jar:com/google/android/material/transformation/FabTransformationBehavior$FabTransformationSpec.class */
    ...
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f, float f2, boolean z, FabTransformationSpec fabTransformationSpec) {
        ...
        int i;
        if (f == 0.0f || f2 == 0.0f) {
            MotionTiming timing2 = fabTransformationSpec.timings.getTiming("translationXLinear");
            timing = fabTransformationSpec.timings.getTiming("translationYLinear");
            ...
            timing = fabTransformationSpec.timings.getTiming("translationYCurveDownwards");
        } else {
            MotionTiming timing3 = fabTransformationSpec.timings.getTiming("translationXCurveUpwards");
            timing = fabTransformationSpec.timings.getTiming("translationYCurveUpwards");
            motionTiming = timing3;
        }
        return new Pair<>(motionTiming, timing);
    }
    ...
    private void createColorAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                ofInt = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, 16777215 & backgroundTint);
            } else {
    ...
    private void createDependencyTranslationAnimation(View view, View view2, boolean z, FabTransformationSpec fabTransformationSpec, List<Animator> list) {
        ...
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, z ? calculateTranslationY : this.dependencyOriginalTranslationY);
    ...
    private void createExpansionAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, float f, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                createCircularReveal = CircularRevealCompat.createCircularReveal(circularRevealWidget, calculateRevealCenterX, calculateRevealCenterY, width);
    ...
    private void createTranslationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        if (z) {
            ...
            ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(view2, View.TRANSLATION_X, -calculateTranslationX);
            ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Y, -calculateTranslationY);
