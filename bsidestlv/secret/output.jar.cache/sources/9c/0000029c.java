...
/* loaded from: output.jar:androidx/constraintlayout/core/motion/Motion.class */
public class Motion implements TypedValues {
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            motionWidget.layout(i4, (int) f7, (int) (f6 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f2)), (int) (f7 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f2)));
        }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        this.mInterpolateVariables = new int[i3];
            ...
            while (i20 < size) {
                ...
                if (motionPathsArr[i20].hasCustomData(str8)) {
                    ...
                    if (dArr4 == null) {
                        ...
                        dArr7 = new double[size][motionPathsArr[i20].getCustomDataCount(str8)];
                    }
                    dArr5[i21] = motionPathsArr[i20].time;
                    motionPathsArr[i20].getCustomData(str8, dArr7[i21], 0);
                    i22 = i21 + 1;
                    dArr6 = dArr7;
                }
                i20++;
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i23 = 0; i23 < size; i23++) {
                ...
                dArr8[i23] = motionPathsArr[i23].time;
                dArr9[i23][0] = motionPathsArr[i23].x;
                dArr9[i23][1] = motionPathsArr[i23].y;
            }
