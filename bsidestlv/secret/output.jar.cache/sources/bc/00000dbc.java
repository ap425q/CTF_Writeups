...
/* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform.class */
public final class MaterialContainerTransform extends Transition {
    ...
    /* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform$FadeMode.class */
    public @interface FadeMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform$FitMode.class */
    public @interface FitMode {
    }

    /* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform$ProgressThresholds.class */
    ...
    /* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform$ProgressThresholdsGroup.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform$TransitionDirection.class */
    public @interface TransitionDirection {
    }

    /* loaded from: output.jar:com/google/android/material/transition/MaterialContainerTransform$TransitionDrawable.class */
