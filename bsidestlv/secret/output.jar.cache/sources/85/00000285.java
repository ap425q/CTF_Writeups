...
/* loaded from: output.jar:androidx/constraintlayout/core/ArrayLinkedVariables.class */
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    SolverVariable getPivotCandidate() {
        ...
        SolverVariable solverVariable2 = this.candidate;
        if (solverVariable2 == null) {
            ...
            while (true) {
                ...
                if (this.mArrayValues[i] < 0.0f) {
                    SolverVariable solverVariable5 = this.mCache.mIndexedVariables[this.mArrayIndices[i]];
                    if (solverVariable != null) {
                        solverVariable4 = solverVariable;
                        if (solverVariable.strength >= solverVariable5.strength) {
                        }
                    }
