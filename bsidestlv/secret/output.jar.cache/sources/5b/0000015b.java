...
/* loaded from: output.jar:androidx/appcompat/widget/ActionBarContextView.class */
public class ActionBarContextView extends AbsActionBarView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (linearLayout != null) {
            ...
            if (this.mCustomView == null) {
                if (this.mTitleOptional) {
                    ...
                    i6 = measureChildView(linearLayout, i5, makeMeasureSpec, 0);
                }
            }
        }
        View view2 = this.mCustomView;
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(i8, i7), View.MeasureSpec.makeMeasureSpec(i10, i9));
        }
