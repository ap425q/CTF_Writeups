...
/* loaded from: output.jar:com/google/android/material/datepicker/UtcDates.class */
class UtcDates {
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        if (pattern.replaceAll("[^y]", "").length() == 1) {
            str = pattern.replace("y", "yyyy");
        }
        return str.replace("d", string3).replace("M", string2).replace("y", string);
    }
