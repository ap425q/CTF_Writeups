...
/* loaded from: output.jar:androidx/emoji2/text/EmojiCompat.class */
public class EmojiCompat {
    ...
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$CompatInternal.class */
    ...
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$CompatInternal19.class */
    ...
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$Config.class */
    ...
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$GlyphChecker.class */
    public interface GlyphChecker {
        boolean hasGlyph(CharSequence charSequence, int i, int i2, int i3);
    }

    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$InitCallback.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$ListenerDispatcher.class */
    ...
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$LoadStrategy.class */
    public @interface LoadStrategy {
    }

    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$MetadataRepoLoader.class */
    public interface MetadataRepoLoader {
        void load(MetadataRepoLoaderCallback metadataRepoLoaderCallback);
    }

    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$MetadataRepoLoaderCallback.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$ReplaceStrategy.class */
    public @interface ReplaceStrategy {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/emoji2/text/EmojiCompat$SpanFactory.class */
    ...
    public static EmojiCompat init(Config config) {
        ...
        if (emojiCompat == null) {
            synchronized (INSTANCE_LOCK) {
                EmojiCompat emojiCompat3 = sInstance;
                emojiCompat2 = emojiCompat3;
                if (emojiCompat3 == null) {
                    emojiCompat2 = new EmojiCompat(config);
                    sInstance = emojiCompat2;
                }
            }
        }
        return emojiCompat2;
    ...
    public CharSequence process(CharSequence charSequence, int i, int i2, int i3, int i4) {
        ...
        if (charSequence.length() != 0) {
            if (i == i2) {
                ...
                charSequence2 = this.mHelper.process(charSequence, i, i2, i3, z);
            }
        }
