...
/* loaded from: output.jar:androidx/recyclerview/widget/MessageThreadUtil.class */
class MessageThreadUtil<T> implements ThreadUtil<T> {

    /* renamed from: androidx.recyclerview.widget.MessageThreadUtil$1  reason: invalid class name */
    /* loaded from: output.jar:androidx/recyclerview/widget/MessageThreadUtil$1.class */
    ...
    /* loaded from: output.jar:androidx/recyclerview/widget/MessageThreadUtil$2.class */
    ...
    /* loaded from: output.jar:androidx/recyclerview/widget/MessageThreadUtil$MessageQueue.class */
    public static class MessageQueue {
        ...
        void removeMessages(int i) {
            synchronized (this) {
                ...
                if (syncQueueItem3 != null) {
                    ...
                    while (true) {
                        SyncQueueItem syncQueueItem5 = syncQueueItem4;
                        if (syncQueueItem5 == null) {
                            break;
                        }
                        SyncQueueItem syncQueueItem6 = syncQueueItem5.next;
                        if (syncQueueItem5.what == i) {
                            syncQueueItem3.next = syncQueueItem6;
                            syncQueueItem5.recycle();
                        } else {
                            syncQueueItem3 = syncQueueItem5;
                        }
                        syncQueueItem4 = syncQueueItem6;
                    }
                }
            }
        }
        ...
        void sendMessage(SyncQueueItem syncQueueItem) {
            synchronized (this) {
                ...
                syncQueueItem3.next = syncQueueItem;
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/recyclerview/widget/MessageThreadUtil$SyncQueueItem.class */
