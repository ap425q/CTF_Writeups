...
/* loaded from: output.jar:androidx/emoji2/text/flatbuffer/FlexBuffersBuilder.class */
public class FlexBuffersBuilder {
    ...
    /* loaded from: output.jar:androidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value.class */
    public static class Value {
        ...
        public static int elemWidth(int i, int i2, long j, int i3, int i4) {
            ...
            while (true) {
                ...
                int widthUInBits = FlexBuffersBuilder.widthUInBits((int) (((paddingBytes(i3, i6) + i3) + (i4 * i6)) - j));
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        while (i8 < this.stack.size()) {
            int max2 = Math.max(max, this.stack.get(i8).elemWidth(this.bb.writePosition(), i8 + i4));
            int i9 = i7;
            if (z) {
                i9 = i7;
                if (i8 == i2) {
                    i9 = this.stack.get(i8).type;
                    if (!FlexBuffers.isTypedVectorElementType(i9)) {
        ...
        int writePosition = this.bb.writePosition();
        for (int i10 = i2; i10 < this.stack.size(); i10++) {
            writeAny(this.stack.get(i10), align);
        }
        if (!z) {
            while (i2 < this.stack.size()) {
                this.bb.put(this.stack.get(i2).storedPackedType(max));
                i2++;
            }
        }
        if (value != null) {
