...
/* loaded from: output.jar:androidx/core/widget/NestedScrollView.class */
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    /* loaded from: output.jar:androidx/core/widget/NestedScrollView$AccessibilityDelegate.class */
    ...
    /* loaded from: output.jar:androidx/core/widget/NestedScrollView$OnScrollChangeListener.class */
    public interface OnScrollChangeListener {
        void onScrollChange(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: output.jar:androidx/core/widget/NestedScrollView$SavedState.class */
    ...
    */
    ...
    public void draw(Canvas canvas) {
        ...
        if (!this.mEdgeGlowTop.isFinished()) {
            ...
            this.mEdgeGlowTop.setSize(width, i2);
        ...
        this.mEdgeGlowBottom.setSize(i5, i7);
            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (!this.mIsBeingDragged) {
                        ...
                        if (Math.abs(releaseVerticalGlow) > this.mTouchSlop) {
                            ViewParent parent2 = getParent();
                            if (parent2 != null) {
                                parent2.requestDisallowInterceptTouchEvent(true);
                            }
                            this.mIsBeingDragged = true;
                            i3 = releaseVerticalGlow > 0 ? releaseVerticalGlow - this.mTouchSlop : releaseVerticalGlow + this.mTouchSlop;
                        }
                    }
                    if (this.mIsBeingDragged) {
                        int i4 = i3;
                        if (dispatchNestedPreScroll(0, i3, this.mScrollConsumed, this.mScrollOffset, 0)) {
                            i4 = i3 - this.mScrollConsumed[1];
