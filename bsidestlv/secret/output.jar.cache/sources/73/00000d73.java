...
/* loaded from: output.jar:com/google/android/material/timepicker/ClockHandView.class */
public class ClockHandView extends View {
    ...
    /* loaded from: output.jar:com/google/android/material/timepicker/ClockHandView$OnActionUpListener.class */
    public interface OnActionUpListener {
        void onActionUp(float f, boolean z);
    }

    /* loaded from: output.jar:com/google/android/material/timepicker/ClockHandView$OnRotateListener.class */
