...
/* loaded from: output.jar:androidx/collection/SimpleArrayMap.class */
public class SimpleArrayMap<K, V> {
    ...
    int indexOf(Object obj, int i) {
        ...
        if (binarySearchHashes >= 0 && !obj.equals(this.mArray[binarySearchHashes << 1])) {
            ...
            while (true) {
                binarySearchHashes--;
                if (binarySearchHashes < 0 || this.mHashes[binarySearchHashes] != i) {
                    break;
                } else if (obj.equals(this.mArray[binarySearchHashes << 1])) {
