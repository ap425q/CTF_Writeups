...
/* loaded from: output.jar:androidx/viewpager2/adapter/FragmentStateAdapter.class */
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    /* loaded from: output.jar:androidx/viewpager2/adapter/FragmentStateAdapter$DataSetChangeObserver.class */
    ...
    /* loaded from: output.jar:androidx/viewpager2/adapter/FragmentStateAdapter$FragmentMaxLifecycleEnforcer.class */
    ...
    public final Parcelable saveState() {
        ...
        for (i = 0; i < this.mSavedStates.size(); i++) {
            long keyAt2 = this.mSavedStates.keyAt(i);
