...
/* loaded from: output.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat.class */
public class AccessibilityNodeInfoCompat {
    ...
    /* loaded from: output.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$AccessibilityActionCompat.class */
    public static class AccessibilityActionCompat {
        ...
        public boolean perform(View view, Bundle bundle) {
            ...
            if (this.mCommand != null) {
                ...
                if (cls2 != null) {
                    try {
                        commandArguments2 = cls2.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                        try {
                            commandArguments2.setBundle(bundle);
                        } catch (Exception e) {
                            commandArguments = commandArguments2;
                            e = e;
                            Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (this.mViewCommandArgumentClass == null ? "null" : cls.getName()), e);
    ...
    /* loaded from: output.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$CollectionInfoCompat.class */
    ...
    /* loaded from: output.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$CollectionItemInfoCompat.class */
    ...
    /* loaded from: output.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$RangeInfoCompat.class */
    ...
    /* loaded from: output.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$TouchDelegateInfoCompat.class */
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        SparseArray sparseArray = spansFromViewTags;
