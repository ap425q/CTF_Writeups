...
/* loaded from: output.jar:androidx/constraintlayout/widget/ConstraintHelper.class */
public abstract class ConstraintHelper extends View {
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (true) {
            ...
            int findId = findId(split[i2].trim());
            int i4 = i;
            if (findId != 0) {
                iArr[i] = findId;
                i4 = i + 1;
    ...
    private int findId(String str) {
        ...
        int i4 = i3;
        if (i3 == 0) {
            i4 = this.myContext.getResources().getIdentifier(str, "id", this.myContext.getPackageName());
        }
        return i4;
    }
        ...
        for (int i = 0; i < this.mCount; i++) {
            ...
            if (viewById == null) {
                ...
                if (findId != 0) {
                    ...
                    view = constraintLayout.getViewById(findId);
                }
            }
            if (view != null) {
