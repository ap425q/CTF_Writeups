...
/* loaded from: output.jar:androidx/constraintlayout/motion/widget/KeyPosition.class */
public class KeyPosition extends KeyPositionBase {
    ...
    /* loaded from: output.jar:androidx/constraintlayout/motion/widget/KeyPosition$Loader.class */
    ...
    private void calcPathPosition(float f, float f2, float f3, float f4) {
        ...
        this.mCalculatedPositionX = f + (f5 * f8) + (f7 * f9);
        this.mCalculatedPositionY = f2 + (f6 * f8) + (f5 * f9);
    }
