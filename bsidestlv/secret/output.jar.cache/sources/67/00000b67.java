...
/* loaded from: output.jar:com/google/android/material/card/MaterialCardViewHelper.class */
public class MaterialCardViewHelper {
    ...
    public void onMeasure(int i, int i2) {
        int i3;
        if (this.clickableForegroundDrawable != null) {
            int i4 = this.checkedIconMargin;
            int i5 = this.checkedIconSize;
            int i6 = (i - i4) - i5;
            int i7 = (i2 - i4) - i5;
            int i8 = i6;
            int i9 = i7;
            if (this.materialCardView.getUseCompatPadding()) {
                i9 = i7 - ((int) Math.ceil(calculateVerticalBackgroundPadding() * 2.0f));
                i8 = i6 - ((int) Math.ceil(calculateHorizontalBackgroundPadding() * 2.0f));
            }
            ...
            this.clickableForegroundDrawable.setLayerInset(2, i10, this.checkedIconMargin, i3, i9);
        }
    }
