...
/* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter.class */
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$HeaderViewHolder.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter.class */
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
            ...
            while (true) {
                ...
                if (menuItemImpl.hasSubMenu()) {
                    ...
                    if (groupId != i2) {
                        ...
                        boolean z7 = menuItemImpl.getIcon() != null;
                        z = z7;
                        i = size4;
                        if (i3 != 0) {
                            i = size4 + 1;
        ...
        int getRowCount() {
            ...
            while (true) {
                int i3 = i2;
                if (i >= NavigationMenuPresenter.this.adapter.getItemCount()) {
                    return i3;
                }
                int i4 = i3;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NavigationMenuHeaderItem.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NavigationMenuItem.class */
    public interface NavigationMenuItem {
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem.class */
    ...
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NavigationMenuViewAccessibilityDelegate.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$NormalViewHolder.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$SeparatorViewHolder.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$SubheaderViewHolder.class */
    ...
    /* loaded from: output.jar:com/google/android/material/internal/NavigationMenuPresenter$ViewHolder.class */
