...
/* loaded from: output.jar:androidx/appcompat/widget/Toolbar.class */
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/Toolbar$InspectionCompanion.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/Toolbar$LayoutParams.class */
    ...
    /* loaded from: output.jar:androidx/appcompat/widget/Toolbar$OnMenuItemClickListener.class */
    public interface OnMenuItemClickListener {
        boolean onMenuItemClick(MenuItem menuItem);
    }

    /* loaded from: output.jar:androidx/appcompat/widget/Toolbar$SavedState.class */
    ...
    /* JADX WARN: Removed duplicated region for block: B:121:0x0548 A[LOOP:0: B:119:0x0542->B:121:0x0548, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:125:0x057d A[LOOP:1: B:123:0x0577->B:125:0x057d, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:129:0x05d0  */
    /* JADX WARN: Removed duplicated region for block: B:136:0x05f6 A[LOOP:2: B:134:0x05f0->B:136:0x05f6, LOOP_END] */
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            i11 = View.combineMeasuredStates(i5, this.mCollapseButtonView.getMeasuredState());
        }
        int currentContentInsetStart = getCurrentContentInsetStart();
        int max = 0 + Math.max(currentContentInsetStart, i9);
        iArr[isLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetStart - i9);
        ...
        while (i20 < childCount) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0) {
                if (shouldLayout(childAt)) {
                    i23 = i18 + measureChildCollapseMargins(childAt, i, i18, i2, 0, iArr);
                    i21 = Math.max(i15, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
                    i22 = View.combineMeasuredStates(i19, childAt.getMeasuredState());
                } else {
                    i21 = i15;
                    i22 = i19;
                    i23 = i18;
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            i7 = measuredHeight + verticalMargins;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i8 = Math.max(i8, measureChildCollapseMargins(this.mSubtitleTextView, i, i18 + i25, i2, i7 + i24, iArr));
        ...
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int resolveSizeAndState = View.resolveSizeAndState(Math.max(i18 + i8 + paddingLeft + paddingRight, getSuggestedMinimumWidth()), i, (-16777216) & i19);
