...
/* loaded from: output.jar:androidx/recyclerview/widget/AsyncListDiffer.class */
public class AsyncListDiffer<T> {
    ...
    /* loaded from: output.jar:androidx/recyclerview/widget/AsyncListDiffer$ListListener.class */
    public interface ListListener<T> {
        void onCurrentListChanged(List<T> list, List<T> list2);
    }

    /* loaded from: output.jar:androidx/recyclerview/widget/AsyncListDiffer$MainThreadExecutor.class */
