...
public final class ActorKt {
    public static final <E> SendChannel<E> actor(CoroutineScope $this$actor, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> function1, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        CoroutineContext newContext = kotlinx.coroutines.CoroutineContext.newCoroutineContext($this$actor, context);
        ...
        if (start.isLazy()) {
            ...
            coroutine = new Actor(newContext, channel, true);
        }
        if (function1 != null) {
