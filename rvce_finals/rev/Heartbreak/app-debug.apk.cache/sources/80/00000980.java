...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            if (this.type == 1) {
                return FlexBuffers.readInt(this.f88bb, this.end, this.parentWidth);
            }
            switch (this.type) {
                case 0:
                    return 0;
                case 2:
                    return (int) FlexBuffers.readUInt(this.f88bb, this.end, this.parentWidth);
                case 3:
                    return (int) FlexBuffers.readDouble(this.f88bb, this.end, this.parentWidth);
                case 5:
                    return Integer.parseInt(asString());
                case 6:
                    return FlexBuffers.readInt(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 7:
                    return (int) FlexBuffers.readUInt(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.parentWidth);
                case 8:
                    return (int) FlexBuffers.readDouble(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 10:
        ...
        public long asUInt() {
            if (this.type == 2) {
                return FlexBuffers.readUInt(this.f88bb, this.end, this.parentWidth);
            }
            switch (this.type) {
                case 0:
                    return 0L;
                case 1:
                    return FlexBuffers.readLong(this.f88bb, this.end, this.parentWidth);
                case 3:
                    return (long) FlexBuffers.readDouble(this.f88bb, this.end, this.parentWidth);
                case 5:
                    return Long.parseLong(asString());
                case 6:
                    return FlexBuffers.readLong(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 7:
                    return FlexBuffers.readUInt(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 8:
                    return (long) FlexBuffers.readDouble(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.parentWidth);
                case 10:
                    return asVector().size();
                case 26:
                    return FlexBuffers.readInt(this.f88bb, this.end, this.parentWidth);
        ...
        public long asLong() {
            ...
            switch (this.type) {
                ...
                case 6:
                    return FlexBuffers.readLong(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 7:
                    return FlexBuffers.readUInt(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.parentWidth);
                case 8:
                    return (long) FlexBuffers.readDouble(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 10:
                    return asVector().size();
                case 26:
                    return FlexBuffers.readInt(this.f88bb, this.end, this.parentWidth);
        ...
        public double asFloat() {
            if (this.type == 3) {
                return FlexBuffers.readDouble(this.f88bb, this.end, this.parentWidth);
            }
            switch (this.type) {
                case 0:
                    return 0.0d;
                ...
                case 7:
                    return FlexBuffers.readUInt(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 8:
                    return FlexBuffers.readDouble(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
                case 10:
                    return asVector().size();
                default:
                    return 0.0d;
        ...
        public Key asKey() {
            if (isKey()) {
                return new Key(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
            }
            return Key.empty();
        }
        ...
        public String asString() {
            if (isString()) {
                int start = FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth);
                int size = (int) FlexBuffers.readUInt(this.f88bb, start - this.byteWidth, this.byteWidth);
                return this.f88bb.getString(start, size);
            } else if (isKey()) {
                int start2 = FlexBuffers.indirect(this.f88bb, this.end, this.byteWidth);
                int i = start2;
                while (this.f88bb.get(i) != 0) {
                    i++;
                }
                return this.f88bb.getString(start2, i - start2);
            } else {
                return "";
            }
        }
        ...
        public Map asMap() {
            if (isMap()) {
                return new Map(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
            }
            return Map.empty();
        }
        ...
        public Vector asVector() {
            if (isVector()) {
                return new Vector(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
            }
            if (this.type == 15) {
                return new TypedVector(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth, 4);
            }
            if (FlexBuffers.isTypedVector(this.type)) {
                return new TypedVector(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth, FlexBuffers.toTypedVectorElementType(this.type));
            }
            return Vector.empty();
        }
        ...
        public Blob asBlob() {
            if (isBlob() || isString()) {
                return new Blob(this.f88bb, FlexBuffers.indirect(this.f88bb, this.end, this.parentWidth), this.byteWidth);
            }
            return Blob.empty();
        }

        public boolean asBoolean() {
            return isBoolean() ? this.f88bb.get(this.end) != 0 : asUInt() != 0;
        }
    ...
    public static abstract class Sized extends Object {
        ...
        Sized(ReadBuf buff, int end, int byteWidth) {
            ...
            this.size = FlexBuffers.readInt(this.f87bb, end - byteWidth, byteWidth);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer dup = ByteBuffer.wrap(this.f87bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                result[i] = this.f87bb.get(this.end + i);
            }
            return result;
        }
        ...
        public byte get(int pos) {
            ...
            return this.f87bb.get(this.end + pos);
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public String toString() {
            return this.f87bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append(Typography.quote);
            sb.append(this.f87bb.getString(this.end, size()));
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f87bb, FlexBuffers.indirect(this.f87bb, keysOffset, this.byteWidth), FlexBuffers.readInt(this.f87bb, this.byteWidth + keysOffset, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f87bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int index) {
            ...
            int packedType = Unsigned.byteToUnsignedInt(this.f87bb.get((int) (this.end + (this.byteWidth * len) + index)));
            int obj_end = this.end + (this.byteWidth * index);
            return new Reference(this.f87bb, obj_end, this.byteWidth, packedType);
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int pos) {
            ...
            return new Reference(this.f87bb, childPos, this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int pos) {
            ...
            return new Key(this.vec.f87bb, FlexBuffers.indirect(this.vec.f87bb, childPos, this.vec.byteWidth), 1);
        }
