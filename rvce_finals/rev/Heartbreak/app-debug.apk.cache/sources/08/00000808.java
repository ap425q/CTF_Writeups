...
public final class View {
    ...
    public static final void doOnLayout(android.view.View $this$doOnLayout, final Function1<? super android.view.View, Unit> function1) {
    ...
    public static final OneShotPreDrawListener doOnPreDraw(final android.view.View $this$doOnPreDraw, final Function1<? super android.view.View, Unit> function1) {
    ...
    public static final void doOnAttach(final android.view.View $this$doOnAttach, final Function1<? super android.view.View, Unit> function1) {
    ...
    public static final void doOnDetach(final android.view.View $this$doOnDetach, final Function1<? super android.view.View, Unit> function1) {
    ...
    public static /* synthetic */ void updatePaddingRelative$default(android.view.View $this$updatePaddingRelative_u24default, int start, int top, int end, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final void updatePaddingRelative(android.view.View $this$updatePaddingRelative, int start, int top, int end, int bottom) {
        $this$updatePaddingRelative.setPaddingRelative(start, top, end, bottom);
    }

    public static /* synthetic */ void updatePadding$default(android.view.View $this$updatePadding_u24default, int left, int top, int right, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final void updatePadding(android.view.View $this$updatePadding, int left, int top, int right, int bottom) {
        $this$updatePadding.setPadding(left, top, right, bottom);
    }

    public static final void setPadding(android.view.View $this$setPadding, int size) {
        $this$setPadding.setPadding(size, size, size, size);
    }

    public static final Runnable postDelayed(android.view.View $this$postDelayed, long delayInMillis, final Functions<Unit> functions) {
    ...
    public static final Runnable postOnAnimationDelayed(android.view.View $this$postOnAnimationDelayed, long delayInMillis, final Functions<Unit> functions) {
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                View.m191$r8$lambda$dpsg06okbB847jib5crd0X1meI(Functions.this);
            }
        };
    ...
    public static final Bitmap drawToBitmap(android.view.View $this$drawToBitmap, Bitmap.Config config) {
    ...
    public static final boolean isVisible(android.view.View $this$isVisible) {
        return $this$isVisible.getVisibility() == 0;
    }

    public static final void setVisible(android.view.View $this$isVisible, boolean value) {
        $this$isVisible.setVisibility(value ? 0 : 8);
    }

    public static final boolean isInvisible(android.view.View $this$isInvisible) {
        return $this$isInvisible.getVisibility() == 4;
    }

    public static final void setInvisible(android.view.View $this$isInvisible, boolean value) {
        $this$isInvisible.setVisibility(value ? 4 : 0);
    }

    public static final boolean isGone(android.view.View $this$isGone) {
        return $this$isGone.getVisibility() == 8;
    }

    public static final void setGone(android.view.View $this$isGone, boolean value) {
        $this$isGone.setVisibility(value ? 8 : 0);
    }

    public static final void updateLayoutParams(android.view.View $this$updateLayoutParams, Function1<? super ViewGroup.LayoutParams, Unit> function1) {
    ...
    public static final /* synthetic */ <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(android.view.View $this$updateLayoutParams, Function1<? super T, Unit> function1) {
    ...
    public static final int getMarginLeft(android.view.View $this$marginLeft) {
    ...
    public static final int getMarginTop(android.view.View $this$marginTop) {
    ...
    public static final int getMarginRight(android.view.View $this$marginRight) {
    ...
    public static final int getMarginBottom(android.view.View $this$marginBottom) {
    ...
    public static final int getMarginStart(android.view.View $this$marginStart) {
    ...
    public static final int getMarginEnd(android.view.View $this$marginEnd) {
    ...
    public static final Sequence<ViewParent> getAncestors(android.view.View $this$ancestors) {
        return SequencesKt.generateSequence($this$ancestors.getParent(), ViewKt$ancestors$1.INSTANCE);
    }

    public static final Sequence<android.view.View> getAllViews(android.view.View $this$allViews) {
