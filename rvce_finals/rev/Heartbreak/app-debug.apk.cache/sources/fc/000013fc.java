...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1437getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m220boximpl(result);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m230unboximpl());
                }
            }
        }
    }
