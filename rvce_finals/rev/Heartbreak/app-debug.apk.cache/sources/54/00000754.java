...
public final class LongSparseArray {
    ...
    public static final <T> boolean contains(android.util.LongSparseArray<T> longSparseArray, long key) {
    ...
    public static final <T> boolean containsKey(android.util.LongSparseArray<T> longSparseArray, long key) {
        return longSparseArray.indexOfKey(key) >= 0;
    }
    ...
    public static final <T> T getOrDefault(android.util.LongSparseArray<T> longSparseArray, long key, T t) {
        T t2 = longSparseArray.get(key);
        return t2 == null ? t : t2;
    }

    public static final <T> T getOrElse(android.util.LongSparseArray<T> longSparseArray, long key, Functions<? extends T> functions) {
    ...
    public static final <T> boolean remove(android.util.LongSparseArray<T> longSparseArray, long key, T t) {
    ...
    public static final <T> void forEach(android.util.LongSparseArray<T> longSparseArray, Function2<? super Long, ? super T, Unit> function2) {
