...
public final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        while (true) {
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    curTail = s$iv2;
                    if (it$iv$iv$iv == ConcurrentLinkedList.CLOSED) {
                        m1776constructorimpl = SegmentOrClosed.m1776constructorimpl(ConcurrentLinkedList.CLOSED);
                        break;
                    }
                    ...
                    m1776constructorimpl = SegmentOrClosed.m1776constructorimpl(cur$iv$iv);
                    curTail = s$iv2;
                    break;
                }
            }
            s$iv = m1776constructorimpl;
            if (SegmentOrClosed.m1781isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1779getSegmentimpl(s$iv);
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    z = false;
                    break;
                } else if (C0137xc40028dd.m169m(tail$FU, this, cur$iv$iv2, to$iv$iv)) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1779getSegmentimpl(s$iv);
        ...
        CompletionHandler $this$asHandler$iv = new CancelSemaphoreAcquisitionHandler(segment, i3);
        ...
        do {
            ...
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    continue;
                    break;
                } else if (C0137xc40028dd.m169m(head$FU, this, cur$iv$iv2, to$iv$iv)) {
                    if (cur$iv$iv2.decPointers$kotlinx_coroutines_core()) {
                        cur$iv$iv2.remove();
                    }
                    z = true;
