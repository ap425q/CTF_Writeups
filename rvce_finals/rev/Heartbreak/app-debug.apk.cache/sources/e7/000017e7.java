...
public final /* synthetic */ class Delay {
    ...
    public static final <T> Flow<T> m1753debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1711toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1711toDelayMillisLRDsOJo(function1.invoke(t).m1601unboximpl()));
            }
        });
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return Produce.produce$default($this$fixedPeriodTicker, null, 0, new FlowKt__DelayKt$fixedPeriodTicker$3(initialDelayMillis, delayMillis, null), 1, null);
    }

    /* renamed from: sample-HG0u8IE */
    public static final <T> Flow<T> m1754sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1711toDelayMillisLRDsOJo(period));
    }
}