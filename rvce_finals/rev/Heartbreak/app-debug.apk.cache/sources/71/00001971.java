...
public final class WorkQueue {
    ...
    public final void offloadAllWorkTo(Tasks globalQueue) {
    ...
    private final long tryStealLastScheduled(WorkQueue victim, boolean blockingOnly) {
        ...
        } while (!C0137xc40028dd.m169m(lastScheduledTask$FU, victim, lastScheduled, null));
        add$default(this, lastScheduled, false, 2, null);
        return -1L;
    }

    private final boolean pollTo(Tasks queue) {
