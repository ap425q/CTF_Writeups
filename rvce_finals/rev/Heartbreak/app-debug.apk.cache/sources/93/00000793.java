...
public class DifferentialMotionFlingController {
    ...
    public static /* synthetic */ void $r8$lambda$lv23FpWloyumz6IvnMabmJR9BpE(Context context, int[] iArr, MotionEvent motionEvent, int i) {
        calculateFlingVelocityThresholds(context, iArr, motionEvent, i);
    }

    public static /* synthetic */ float $r8$lambda$rCNQ1h5KBIaVcUXhwymI_1638W0(VelocityTracker velocityTracker, MotionEvent motionEvent, int i) {
    ...
    public DifferentialMotionFlingController(Context context, DifferentialMotionFlingTarget target) {
        this(context, target, new FlingVelocityThresholdCalculator() { // from class: androidx.core.view.DifferentialMotionFlingController$$ExternalSyntheticLambda0
            ...
            public final void calculateFlingVelocityThresholds(Context context2, int[] iArr, MotionEvent motionEvent, int i) {
                DifferentialMotionFlingController.$r8$lambda$lv23FpWloyumz6IvnMabmJR9BpE(context2, iArr, motionEvent, i);
            }
            ...
            public final float getCurrentVelocity(VelocityTracker velocityTracker, MotionEvent motionEvent, int i) {
                return DifferentialMotionFlingController.$r8$lambda$rCNQ1h5KBIaVcUXhwymI_1638W0(velocityTracker, motionEvent, i);
            }
        });
    }
