...
public abstract class ConcurrentLinkedListNode<N extends ConcurrentLinkedListNode<N>> {
    ...
    public final N nextOrIfClosed(Functions onClosedAction) {
        Object it = getNextOrClosed();
        if (it == ConcurrentLinkedList.access$getCLOSED$p()) {
    ...
    public final N getNext() {
        ...
        if (it$iv == ConcurrentLinkedList.access$getCLOSED$p()) {
            return null;
        }
        return (N) it$iv;
    }
    ...
    public final boolean trySetNext(N n) {
        return C0137xc40028dd.m169m(_next$FU, this, null, n);
    }
    ...
    public final boolean markAsClosed() {
        return C0137xc40028dd.m169m(_next$FU, this, null, ConcurrentLinkedList.access$getCLOSED$p());
    }
    ...
    public final void remove() {
        ...
        if (Debug.getASSERTIONS_ENABLED() && (!isTail()) == 0) {
            throw new AssertionError();
        }
        while (true) {
