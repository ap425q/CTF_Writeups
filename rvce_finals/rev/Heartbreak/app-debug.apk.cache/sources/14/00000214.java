...
public class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this.mView, this.mView.getContext(), C0028R.styleable.AppCompatTextHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        ...
        if (ap != -1) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0028R.styleable.TextAppearance_fontVariationSettings)) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && a3.hasValue(C0028R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = a3.getString(C0028R.styleable.TextAppearance_fontVariationSettings);
        }
        if (Build.VERSION.SDK_INT >= 28 && a3.hasValue(C0028R.styleable.TextAppearance_android_textSize) && a3.getDimensionPixelSize(C0028R.styleable.TextAppearance_android_textSize, -1) == 0) {
        ...
        if (!a4.hasValue(C0028R.styleable.AppCompatTextView_lineHeight)) {
            i = -1;
        } else {
            TypedValue peekValue = a4.peekValue(C0028R.styleable.AppCompatTextView_lineHeight);
            if (peekValue != null && peekValue.type == 5) {
                ...
                i = -1;
                lineHeight = a4.getDimensionPixelSize(C0028R.styleable.AppCompatTextView_lineHeight, -1);
            }
        }
        a4.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            this.mFontWeight = a.getInt(C0028R.styleable.TextAppearance_android_textFontWeight, -1);
            if (this.mFontWeight != -1) {
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && a.hasValue(C0028R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0028R.styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, fontVariation);
        }
        a.recycle();
        if (this.mFontTypeface != null) {
