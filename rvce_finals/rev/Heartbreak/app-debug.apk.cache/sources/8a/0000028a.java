...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mShowTextId = propertyMapper.mapBoolean("showText", C0028R.attr.showText);
            this.mSplitTrackId = propertyMapper.mapBoolean("splitTrack", C0028R.attr.splitTrack);
            this.mSwitchMinWidthId = propertyMapper.mapInt("switchMinWidth", C0028R.attr.switchMinWidth);
            this.mSwitchPaddingId = propertyMapper.mapInt("switchPadding", C0028R.attr.switchPadding);
            this.mThumbTextPaddingId = propertyMapper.mapInt("thumbTextPadding", C0028R.attr.thumbTextPadding);
            this.mThumbTintId = propertyMapper.mapObject("thumbTint", C0028R.attr.thumbTint);
            this.mThumbTintModeId = propertyMapper.mapObject("thumbTintMode", C0028R.attr.thumbTintMode);
            this.mTrackId = propertyMapper.mapObject("track", C0028R.attr.track);
            this.mTrackTintId = propertyMapper.mapObject("trackTint", C0028R.attr.trackTint);
            this.mTrackTintModeId = propertyMapper.mapObject("trackTintMode", C0028R.attr.trackTintMode);
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mThumbDrawable = a.getDrawable(C0028R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = a.getDrawable(C0028R.styleable.SwitchCompat_track);
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ViewCompat.setStateDescription(this, this.mTextOn == null ? getResources().getString(C0028R.string.abc_capital_on) : this.mTextOn);
        }
    }

    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ViewCompat.setStateDescription(this, this.mTextOff == null ? getResources().getString(C0028R.string.abc_capital_off) : this.mTextOff);
        }
    }
