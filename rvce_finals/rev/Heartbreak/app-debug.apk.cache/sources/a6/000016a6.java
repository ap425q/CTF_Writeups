...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1774scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    ...
    public final void mo1773dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final boolean enqueueImpl(Runnable task) {
        ...
        while (true) {
            ...
            if (queue == null) {
                if (C0137xc40028dd.m169m(_queue$FU, this, null, task)) {
                    return true;
                }
                ...
                if (C0137xc40028dd.m169m(_queue$FU, this, queue, newQueue)) {
                    return true;
                }
            } else if (queue != null) {
                switch (((LockFreeTaskQueueCore) queue).addLast(task)) {
                    case 0:
                        return true;
                    case 1:
                        C0137xc40028dd.m169m(_queue$FU, this, queue, ((LockFreeTaskQueueCore) queue).next());
                        continue;
                    case 2:
                        return false;
                }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(queue instanceof LockFreeTaskQueueCore)) {
                ...
                if (C0137xc40028dd.m169m(_queue$FU, this, queue, null)) {
                    if (queue != null) {
    ...
    private final void closeQueue() {
        ...
        while (true) {
            ...
            if (queue == null) {
                ...
                symbol = EventLoop_commonKt.CLOSED_EMPTY;
                if (C0137xc40028dd.m169m(atomicReferenceFieldUpdater, this, null, symbol)) {
                    return;
                }
            } else if (!(queue instanceof LockFreeTaskQueueCore)) {
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedQueue == null) {
            ...
            C0137xc40028dd.m169m(_delayed$FU, $this$scheduleImpl_u24lambda_u2d8, null, new DelayedTaskQueue(now));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: EventLoop.common.kt */
    @Metadata(m29d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\u0010\u0004\u001a\u00060\u0005j\u0002`\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\b\u001a\u00020\tH\u0016J\b\u0010\n\u001a\u00020\u000bH\u0016R\u0012\u0010\u0004\u001a\u00060\u0005j\u0002`\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, m28d2 = {"Lkotlinx/coroutines/EventLoopImplBase$DelayedRunnableTask;", "Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;", "nanoTime", "", "block", "Ljava/lang/Runnable;", "Lkotlinx/coroutines/Runnable;", "(JLjava/lang/Runnable;)V", "run", "", "toString", "", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    /* compiled from: EventLoop.common.kt */
    @Metadata(m29d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005R\u0012\u0010\u0003\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m28d2 = {"Lkotlinx/coroutines/EventLoopImplBase$DelayedTaskQueue;", "Lkotlinx/coroutines/internal/ThreadSafeHeap;", "Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;", "timeNow", "", "(J)V", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
