...
public class _Ranges extends RangesKt__RangesKt {
    ...
    public static final char first(Progressions $this$first) {
        Intrinsics.checkNotNullParameter($this$first, "<this>");
        if ($this$first.isEmpty()) {
            throw new NoSuchElementException("Progression " + $this$first + " is empty.");
        }
    ...
    public static final Character firstOrNull(Progressions $this$firstOrNull) {
        Intrinsics.checkNotNullParameter($this$firstOrNull, "<this>");
        if ($this$firstOrNull.isEmpty()) {
            return null;
        }
    ...
    public static final char last(Progressions $this$last) {
        Intrinsics.checkNotNullParameter($this$last, "<this>");
        if ($this$last.isEmpty()) {
            throw new NoSuchElementException("Progression " + $this$last + " is empty.");
        }
    ...
    public static final Character lastOrNull(Progressions $this$lastOrNull) {
        Intrinsics.checkNotNullParameter($this$lastOrNull, "<this>");
        if ($this$lastOrNull.isEmpty()) {
            return null;
        }
    ...
    private static final char random(PrimitiveRanges $this$random) {
        Intrinsics.checkNotNullParameter($this$random, "<this>");
        return RangesKt.random($this$random, Random.Default);
    }
    ...
    public static final char random(PrimitiveRanges $this$random, Random random) {
        Intrinsics.checkNotNullParameter($this$random, "<this>");
        Intrinsics.checkNotNullParameter(random, "random");
        try {
    ...
    private static final Character randomOrNull(PrimitiveRanges $this$randomOrNull) {
        Intrinsics.checkNotNullParameter($this$randomOrNull, "<this>");
        return RangesKt.randomOrNull($this$randomOrNull, Random.Default);
    }
    ...
    public static final Character randomOrNull(PrimitiveRanges $this$randomOrNull, Random random) {
        Intrinsics.checkNotNullParameter($this$randomOrNull, "<this>");
        Intrinsics.checkNotNullParameter(random, "random");
        if ($this$randomOrNull.isEmpty()) {
            return null;
    ...
    private static final boolean contains(PrimitiveRanges $this$contains, Character element) {
        Intrinsics.checkNotNullParameter($this$contains, "<this>");
    ...
    public static final Progressions reversed(Progressions $this$reversed) {
        Intrinsics.checkNotNullParameter($this$reversed, "<this>");
    ...
    public static final Progressions step(Progressions $this$step, int step) {
        Intrinsics.checkNotNullParameter($this$step, "<this>");
        RangesKt.checkStepIsPositive(step > 0, Integer.valueOf(step));
    ...
    public static final PrimitiveRanges until(char $this$until, char to) {
        return Intrinsics.compare((int) to, 0) <= 0 ? PrimitiveRanges.Companion.getEMPTY() : new PrimitiveRanges($this$until, (char) (to - 1));
    }
