...
@Metadata(m29d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÁ\u0002\u0018\u00002\u00020\u0001:\u0001\fB\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0005\u001a\u00020\u0006H\u0002J\u001a\u0010\u0007\u001a\u00020\u00062\b\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, m28d2 = {"Lkotlinx/coroutines/debug/AgentPremain;", "", "()V", "enableCreationStackTraces", "", "installSignalHandler", "", "premain", "args", "", "instrumentation", "Ljava/lang/instrument/Instrumentation;", "DebugProbesTransformer", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class AgentPremain {
    ...
    /* renamed from: $r8$lambda$dZ6aaVgxuad4u6m9DEFCVZ-Ic5g */
    public static /* synthetic */ void m1748$r8$lambda$dZ6aaVgxuad4u6m9DEFCVZIc5g(Signal signal) {
        m1749installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m221constructorimpl = Result.m221constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m221constructorimpl = Result.m221constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m227isFailureimpl(m221constructorimpl) ? null : m221constructorimpl;
    ...
    public static final class DebugProbesTransformer implements ClassFileTransformer {
        ...
        public byte[] transform(ClassLoader loader, String className, Class<?> cls, ProtectionDomain protectionDomain, byte[] classfileBuffer) {
            ...
            AgentInstallationType.INSTANCE.setInstalledStatically$kotlinx_coroutines_core(true);
            return IOStreams.readBytes(loader.getResourceAsStream("DebugProbesKt.bin"));
        }
    }
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1748$r8$lambda$dZ6aaVgxuad4u6m9DEFCVZIc5g(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1749installSignalHandler$lambda1(Signal it) {
