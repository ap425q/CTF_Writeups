...
public class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0028R.layout.abc_tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0028R.C0031id.message);
        ...
        this.mLayoutParams.windowAnimations = C0028R.style.Animation_AppCompat_Tooltip;
