...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0181R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    this.mReferenceIds = a.getString(attr);
                    setIds(this.mReferenceIds);
                } else if (attr == C0181R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String referenceId) {
        ...
        if (rscId == 0) {
            try {
                Field field = C0181R.C0184id.class.getField(referenceId);
