...
public class SpringStopEngine implements StopEngine {
    ...
    public float getAcceleration() {
        ...
        return ((float) (((-k) * x) - (this.f37mV * c))) / this.mMass;
    }
    ...
    private void compute(double dt) {
        ...
        while (i < overSample) {
            double x = this.mPos - this.mTargetPos;
            double a = (((-k) * x) - (this.f37mV * c)) / this.mMass;
            double avgV = this.f37mV + ((a * dt2) / 2.0d);
            double x2 = this.mPos;
            ...
            double dv = a3 * dt2;
            double c2 = c;
            double c3 = this.f37mV;
            this.f37mV = (float) (this.f37mV + dv);
