    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        if (i2 >= 0 && this.mBarrierType < 4) {
            ...
            if (this.resolved) {
                this.resolved = false;
                if (this.mBarrierType == 0 || this.mBarrierType == 1) {
                    system.addEquality(this.mLeft.mSolverVariable, this.f41mX);
                    system.addEquality(this.mRight.mSolverVariable, this.f41mX);
                    return;
                } else if (this.mBarrierType == 2 || this.mBarrierType == 3) {
                    system.addEquality(this.mTop.mSolverVariable, this.f42mY);
                    system.addEquality(this.mBottom.mSolverVariable, this.f42mY);
                    return;
                } else {
                    return;
                }
