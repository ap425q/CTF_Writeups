    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0028R.C0031id.decor_content_parent);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, (AttributeSet) null, C0028R.attr.actionModePopupWindowStyle);
    ...
    public static final class PanelFeatureState {
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0028R.layout.abc_list_menu_item_layout);
