...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void saturation(float saturationStrength) {
            ...
            float Gt = 0.587f * MS;
            float Bt = 0.114f * MS;
            this.f59m[0] = Rt + saturationStrength;
            this.f59m[1] = Gt;
            this.f59m[2] = Bt;
            this.f59m[3] = 0.0f;
            this.f59m[4] = 0.0f;
            this.f59m[5] = Rt;
            this.f59m[6] = Gt + saturationStrength;
            this.f59m[7] = Bt;
            this.f59m[8] = 0.0f;
            this.f59m[9] = 0.0f;
            this.f59m[10] = Rt;
            this.f59m[11] = Gt;
            this.f59m[12] = Bt + saturationStrength;
            this.f59m[13] = 0.0f;
            this.f59m[14] = 0.0f;
            this.f59m[15] = 0.0f;
            this.f59m[16] = 0.0f;
        ...
        private void brightness(float brightness) {
            this.f59m[0] = brightness;
            this.f59m[1] = 0.0f;
            this.f59m[2] = 0.0f;
            this.f59m[3] = 0.0f;
            this.f59m[4] = 0.0f;
            this.f59m[5] = 0.0f;
            this.f59m[6] = brightness;
            this.f59m[7] = 0.0f;
            this.f59m[8] = 0.0f;
            this.f59m[9] = 0.0f;
            this.f59m[10] = 0.0f;
            this.f59m[11] = 0.0f;
            this.f59m[12] = brightness;
            this.f59m[13] = 0.0f;
            this.f59m[14] = 0.0f;
            this.f59m[15] = 0.0f;
            this.f59m[16] = 0.0f;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0181R.styleable.ImageFilterView);
            int N = a.getIndexCount();
            this.mAltDrawable = a.getDrawable(C0181R.styleable.ImageFilterView_altSrc);
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0181R.styleable.ImageFilterView_crossfade) {
                    this.mCrossfade = a.getFloat(attr, 0.0f);
                } else if (attr == C0181R.styleable.ImageFilterView_warmth) {
                    setWarmth(a.getFloat(attr, 0.0f));
                } else if (attr == C0181R.styleable.ImageFilterView_saturation) {
                    setSaturation(a.getFloat(attr, 0.0f));
                } else if (attr == C0181R.styleable.ImageFilterView_contrast) {
                    setContrast(a.getFloat(attr, 0.0f));
                } else if (attr == C0181R.styleable.ImageFilterView_brightness) {
                    setBrightness(a.getFloat(attr, 0.0f));
                } else if (attr == C0181R.styleable.ImageFilterView_round) {
                    setRound(a.getDimension(attr, 0.0f));
                } else if (attr == C0181R.styleable.ImageFilterView_roundPercent) {
                    setRoundPercent(a.getFloat(attr, 0.0f));
                } else if (attr == C0181R.styleable.ImageFilterView_overlay) {
                    setOverlay(a.getBoolean(attr, this.mOverlay));
                } else if (attr == C0181R.styleable.ImageFilterView_imagePanX) {
                    setImagePanX(a.getFloat(attr, this.mPanX));
                } else if (attr == C0181R.styleable.ImageFilterView_imagePanY) {
                    setImagePanY(a.getFloat(attr, this.mPanY));
                } else if (attr == C0181R.styleable.ImageFilterView_imageRotate) {
                    setImageRotate(a.getFloat(attr, this.mRotate));
                } else if (attr == C0181R.styleable.ImageFilterView_imageZoom) {
