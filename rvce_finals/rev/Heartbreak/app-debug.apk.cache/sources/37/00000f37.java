...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box cube) {
        ...
        double xx = ((((((this.moments[getIndex(cube.f194r1, cube.f192g1, cube.f190b1)] - this.moments[getIndex(cube.f194r1, cube.f192g1, cube.f189b0)]) - this.moments[getIndex(cube.f194r1, cube.f191g0, cube.f190b1)]) + this.moments[getIndex(cube.f194r1, cube.f191g0, cube.f189b0)]) - this.moments[getIndex(cube.f193r0, cube.f192g1, cube.f190b1)]) + this.moments[getIndex(cube.f193r0, cube.f192g1, cube.f189b0)]) + this.moments[getIndex(cube.f193r0, cube.f191g0, cube.f190b1)]) - this.moments[getIndex(cube.f193r0, cube.f191g0, cube.f189b0)];
    ...
    Boolean cut(Box one, Box two) {
        ...
        MaximizeResult maxRResult = maximize(one, Direction.RED, one.f193r0 + 1, one.f194r1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxGResult = maximize(one, Direction.GREEN, one.f191g0 + 1, one.f192g1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxBResult = maximize(one, Direction.BLUE, one.f189b0 + 1, one.f190b1, wholeR, wholeG, wholeB, wholeW);
        ...
        two.f194r1 = one.f194r1;
        two.f192g1 = one.f192g1;
        two.f190b1 = one.f190b1;
        switch (cutDirection) {
            case RED:
                one.f194r1 = maxRResult.cutLocation;
                two.f193r0 = one.f194r1;
                two.f191g0 = one.f191g0;
                two.f189b0 = one.f189b0;
                break;
            case GREEN:
                one.f192g1 = maxGResult.cutLocation;
                two.f193r0 = one.f193r0;
                two.f191g0 = one.f192g1;
                two.f189b0 = one.f189b0;
                break;
            case BLUE:
                one.f190b1 = maxBResult.cutLocation;
                two.f193r0 = one.f193r0;
                two.f191g0 = one.f191g0;
                two.f189b0 = one.f190b1;
                break;
        }
        one.vol = (one.f194r1 - one.f193r0) * (one.f192g1 - one.f191g0) * (one.f190b1 - one.f189b0);
        two.vol = (two.f194r1 - two.f193r0) * (two.f192g1 - two.f191g0) * (two.f190b1 - two.f189b0);
        return true;
    }
    ...
    static int volume(Box cube, int[] moment) {
        return ((((((moment[getIndex(cube.f194r1, cube.f192g1, cube.f190b1)] - moment[getIndex(cube.f194r1, cube.f192g1, cube.f189b0)]) - moment[getIndex(cube.f194r1, cube.f191g0, cube.f190b1)]) + moment[getIndex(cube.f194r1, cube.f191g0, cube.f189b0)]) - moment[getIndex(cube.f193r0, cube.f192g1, cube.f190b1)]) + moment[getIndex(cube.f193r0, cube.f192g1, cube.f189b0)]) + moment[getIndex(cube.f193r0, cube.f191g0, cube.f190b1)]) - moment[getIndex(cube.f193r0, cube.f191g0, cube.f189b0)];
    }

    static int bottom(Box cube, Direction direction, int[] moment) {
        switch (direction) {
            case RED:
                return (((-moment[getIndex(cube.f193r0, cube.f192g1, cube.f190b1)]) + moment[getIndex(cube.f193r0, cube.f192g1, cube.f189b0)]) + moment[getIndex(cube.f193r0, cube.f191g0, cube.f190b1)]) - moment[getIndex(cube.f193r0, cube.f191g0, cube.f189b0)];
            case GREEN:
                return (((-moment[getIndex(cube.f194r1, cube.f191g0, cube.f190b1)]) + moment[getIndex(cube.f194r1, cube.f191g0, cube.f189b0)]) + moment[getIndex(cube.f193r0, cube.f191g0, cube.f190b1)]) - moment[getIndex(cube.f193r0, cube.f191g0, cube.f189b0)];
            case BLUE:
                return (((-moment[getIndex(cube.f194r1, cube.f192g1, cube.f189b0)]) + moment[getIndex(cube.f194r1, cube.f191g0, cube.f189b0)]) + moment[getIndex(cube.f193r0, cube.f192g1, cube.f189b0)]) - moment[getIndex(cube.f193r0, cube.f191g0, cube.f189b0)];
            default:
    ...
    static int top(Box cube, Direction direction, int position, int[] moment) {
        switch (direction) {
            case RED:
                return ((moment[getIndex(position, cube.f192g1, cube.f190b1)] - moment[getIndex(position, cube.f192g1, cube.f189b0)]) - moment[getIndex(position, cube.f191g0, cube.f190b1)]) + moment[getIndex(position, cube.f191g0, cube.f189b0)];
            case GREEN:
                return ((moment[getIndex(cube.f194r1, position, cube.f190b1)] - moment[getIndex(cube.f194r1, position, cube.f189b0)]) - moment[getIndex(cube.f193r0, position, cube.f190b1)]) + moment[getIndex(cube.f193r0, position, cube.f189b0)];
            case BLUE:
                return ((moment[getIndex(cube.f194r1, cube.f192g1, position)] - moment[getIndex(cube.f194r1, cube.f191g0, position)]) - moment[getIndex(cube.f193r0, cube.f192g1, position)]) + moment[getIndex(cube.f193r0, cube.f191g0, position)];
            default:
                throw new IllegalArgumentException("unexpected direction " + direction);
        }
    }
