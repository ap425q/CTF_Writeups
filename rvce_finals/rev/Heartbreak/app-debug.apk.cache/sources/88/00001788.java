...
@Metadata(m29d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H\u008a@"}, m28d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;"}, m27k = 3, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        switch (this.label) {
            case 0:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[this.$mode.ordinal()]) {
                    case 1:
                        this.label = 1;
                        fixedPeriodTicker = TickerChannels.fixedPeriodTicker(this.$delayMillis, this.$initialDelayMillis, $this$produce.getChannel(), this);
                    ...
                    case 2:
                        this.label = 2;
                        fixedDelayTicker = TickerChannels.fixedDelayTicker(this.$delayMillis, this.$initialDelayMillis, $this$produce.getChannel(), this);
