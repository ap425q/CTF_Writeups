...
class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean enter, boolean isPop) {
        ...
        if (fragment.mContainer != null && fragment.mContainer.getTag(C0315R.C0316id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C0315R.C0316id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(Context context, int transit, boolean enter) {
        ...
        switch (transit) {
            case FragmentTransaction.TRANSIT_FRAGMENT_OPEN /* 4097 */:
                int animAttr = enter ? C0315R.animator.fragment_open_enter : C0315R.animator.fragment_open_exit;
                return animAttr;
            case FragmentTransaction.TRANSIT_FRAGMENT_FADE /* 4099 */:
                int animAttr2 = enter ? C0315R.animator.fragment_fade_enter : C0315R.animator.fragment_fade_exit;
                return animAttr2;
            case FragmentTransaction.TRANSIT_FRAGMENT_MATCH_ACTIVITY_OPEN /* 4100 */:
                ...
                return animAttr3;
            case 8194:
                int animAttr4 = enter ? C0315R.animator.fragment_close_enter : C0315R.animator.fragment_close_exit;
                return animAttr4;
