        ...
        if (list != null) {
            if (!(list instanceof ArrayList)) {
                ...
                if (it2 instanceof AbstractSendChannel.SendBuffered) {
                    ...
                    it = function1 != null ? OnUndeliveredElement.callUndeliveredElementCatchingException(function1, ((AbstractSendChannel.SendBuffered) it2).element, null) : null;
                } else {
                ...
                while (true) {
                    ...
                    if (it3 instanceof AbstractSendChannel.SendBuffered) {
                        ...
                        it = function12 != null ? OnUndeliveredElement.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) it3).element, it) : null;
                    } else {
