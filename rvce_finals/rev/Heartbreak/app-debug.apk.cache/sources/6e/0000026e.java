...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", C0028R.attr.iconifiedByDefault);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", C0028R.attr.queryHint);
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0028R.C0031id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0028R.C0031id.search_edit_frame);
        this.mSearchPlate = findViewById(C0028R.C0031id.search_plate);
        this.mSubmitArea = findViewById(C0028R.C0031id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0028R.C0031id.search_button);
        this.mGoButton = (ImageView) findViewById(C0028R.C0031id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0028R.C0031id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0028R.C0031id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0028R.C0031id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0028R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0028R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0028R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0028R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0028R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0028R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0028R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0028R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0028R.string.abc_searchview_description_search));
