...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements Select<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Functions<? extends Object> functions, Functions<Unit> functions2) {
        ...
        while (true) {
            ...
            if (result == SelectKt.access$getUNDECIDED$p()) {
                Object update = functions.invoke();
                if (C0137xc40028dd.m169m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), update)) {
                    return;
                }
            } else {
                ...
                if (C0137xc40028dd.m169m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    functions2.invoke();
                    return;
                }
            }
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (result$iv == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (C0137xc40028dd.m169m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), update$iv)) {
                    return;
                }
            } else {
                ...
                if (result$iv == update$iv2) {
                    if (C0137xc40028dd.m169m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                        if (Result.m227isFailureimpl(result)) {
                            Continuation $this$resumeWithStackTrace$iv = this.uCont;
                            Throwable exception$iv = Result.m224exceptionOrNullimpl(result);
                            Intrinsics.checkNotNull(exception$iv);
                            Result.Companion companion = Result.Companion;
                            if (Debug.getRECOVER_STACK_TRACES() && ($this$resumeWithStackTrace$iv instanceof CoroutineStackFrame)) {
                                th = StackTraceRecovery.recoverFromStackFrame(exception$iv, (CoroutineStackFrame) $this$resumeWithStackTrace$iv);
                            } else {
                                th = exception$iv;
                            }
                            $this$resumeWithStackTrace$iv.resumeWith(Result.m221constructorimpl(ResultKt.createFailure(th)));
                            return;
                        }
    ...
    public void resumeSelectWithException(Throwable exception) {
        ...
        while (true) {
            ...
            if (result$iv == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (Debug.getRECOVER_STACK_TRACES() && (continuation$iv instanceof CoroutineStackFrame)) {
                ...
                if (result$iv == update$iv2) {
                    if (C0137xc40028dd.m169m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                        ...
                        Result.Companion companion = Result.Companion;
                        intercepted.resumeWith(Result.m221constructorimpl(ResultKt.createFailure(exception)));
                        return;
                    }
                } else {
                    throw new IllegalStateException("Already resumed");
    ...
    public final Object getResult() {
        ...
        Object result = this._result;
        if (result == SelectKt.access$getUNDECIDED$p()) {
            if (C0137xc40028dd.m169m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    /* compiled from: Select.kt */
    @Metadata(m29d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0013\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0096\u0002¨\u0006\u0007"}, m28d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$SelectOnCancelling;", "Lkotlinx/coroutines/JobCancellingNode;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            Result.Companion companion = Result.Companion;
            resumeWith(Result.m221constructorimpl(ResultKt.createFailure(e)));
            ...
            if (result instanceof CompletedExceptionally) {
                ...
                if (exception$iv == (!Debug.getRECOVER_STACK_TRACES() ? e : StackTraceRecovery.unwrapImpl(e))) {
                    return;
                }
            }
    ...
    */
    public java.lang.Object trySelectOther(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp r8) {
        ...
        L2:
            ...
            boolean r4 = androidx.concurrent.futures.C0137xc40028dd.m169m(r4, r7, r6, r5)
            if (r4 != 0) goto L35
            goto L71
        L1d:
            ...
            java.lang.Object r6 = kotlinx.coroutines.selects.SelectKt.getNOT_SELECTED()
            boolean r5 = androidx.concurrent.futures.C0137xc40028dd.m169m(r5, r7, r6, r4)
            if (r5 == 0) goto L71
    ...
    public static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            C0137xc40028dd.m169m(SelectBuilderImpl._state$FU, impl, this, update);
            return decision;
        }
    ...
    @Override // kotlinx.coroutines.selects.SelectInstance
    public Object performAtomicTrySelect(Atomic desc) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: Select.kt */
    @Metadata(m29d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0002\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001B\u0019\u0012\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u001c\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u00022\b\u0010\u000f\u001a\u0004\u0018\u00010\u0002H\u0016J\u0012\u0010\u0010\u001a\u00020\r2\b\u0010\u000f\u001a\u0004\u0018\u00010\u0002H\u0002J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\u00022\b\u0010\u000e\u001a\u0004\u0018\u00010\u0002H\u0016J\n\u0010\u0012\u001a\u0004\u0018\u00010\u0002H\u0002J\b\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\rH\u0002R\u0010\u0010\u0005\u001a\u00020\u00068\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\u00020\tX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u0016"}, m28d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$AtomicSelectOp;", "Lkotlinx/coroutines/internal/AtomicOp;", "", "impl", "Lkotlinx/coroutines/selects/SelectBuilderImpl;", "desc", "Lkotlinx/coroutines/internal/AtomicDesc;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;Lkotlinx/coroutines/internal/AtomicDesc;)V", "opSequence", "", "getOpSequence", "()J", "complete", "", "affected", "failure", "completeSelect", "prepare", "prepareSelectOp", "toString", "", "undoPrepare", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    public static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        public AtomicSelectOp(SelectBuilderImpl<?> selectBuilderImpl, Atomic desc) {
        ...
        private final Object prepareSelectOp() {
            ...
            while (true) {
                ...
                if (state instanceof OpDescriptor) {
                    ...
                    if (C0137xc40028dd.m169m(SelectBuilderImpl._state$FU, this.impl, SelectKt.getNOT_SELECTED(), this)) {
                        return null;
                    }
                } else {
        ...
        private final void undoPrepare() {
            C0137xc40028dd.m169m(SelectBuilderImpl._state$FU, this.impl, this, SelectKt.getNOT_SELECTED());
        }
        ...
        private final void completeSelect(Object failure) {
            ...
            if (C0137xc40028dd.m169m(SelectBuilderImpl._state$FU, this.impl, this, update) && selectSuccess) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: Select.kt */
    @Metadata(m29d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m28d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$DisposeNode;", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "handle", "Lkotlinx/coroutines/DisposableHandle;", "(Lkotlinx/coroutines/DisposableHandle;)V", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
