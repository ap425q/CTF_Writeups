...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0192R.C0194drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0192R.C0195id.notification_main_column);
            outerView.addView(C0192R.C0195id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0192R.C0195id.notification_main_column, 0);
            int top = calculateTopPadding();
            outerView.setViewPadding(C0192R.C0195id.notification_main_column_container, 0, top, 0, 0);
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0192R.C0195id.title, 8);
            outerView.setViewVisibility(C0192R.C0195id.text2, 8);
            outerView.setViewVisibility(C0192R.C0195id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0192R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0192R.dimen.notification_top_pad_large_text);
    ...
    public static class CallStyle extends Style {
        ...
        private String getDefaultText() {
            switch (this.mCallType) {
                case 1:
                    return this.mBuilder.mContext.getResources().getString(C0192R.string.call_notification_incoming_text);
                case 2:
                    return this.mBuilder.mContext.getResources().getString(C0192R.string.call_notification_ongoing_text);
                case 3:
                    return this.mBuilder.mContext.getResources().getString(C0192R.string.call_notification_screening_text);
                default:
                    return null;
            }
        }
        ...
        private Action makeNegativeAction() {
            int i = C0192R.C0194drawable.ic_call_decline_low;
            int icon = C0192R.C0194drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(icon, C0192R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0192R.C0193color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(icon, C0192R.string.call_notification_decline_action, this.mDeclineButtonColor, C0192R.C0193color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i = C0192R.C0194drawable.ic_call_answer_video_low;
            int i2 = C0192R.C0194drawable.ic_call_answer_low;
            int videoIcon = C0192R.C0194drawable.ic_call_answer_video;
            int icon = C0192R.C0194drawable.ic_call_answer;
            if (this.mAnswerIntent == null) {
                return null;
            }
            return makeAction(this.mIsVideo ? videoIcon : icon, this.mIsVideo ? C0192R.string.call_notification_answer_video_action : C0192R.string.call_notification_answer_action, this.mAnswerButtonColor, C0192R.C0193color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0192R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0192R.C0195id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0192R.C0195id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0192R.C0195id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0192R.C0195id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0192R.layout.notification_action_tombstone : C0192R.layout.notification_action);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0192R.C0195id.action_image, createColoredBitmap(icon, C0192R.C0193color.notification_action_color_filter));
            }
            button.setTextViewText(C0192R.C0195id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0192R.C0195id.action_container, action.actionIntent);
            }
            button.setContentDescription(C0192R.C0195id.action_container, action.title);
            return button;
        }
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap icon) {
        ...
        int maxWidth = res.getDimensionPixelSize(C0192R.dimen.compat_notification_large_icon_max_width);
        int maxHeight = res.getDimensionPixelSize(C0192R.dimen.compat_notification_large_icon_max_height);
