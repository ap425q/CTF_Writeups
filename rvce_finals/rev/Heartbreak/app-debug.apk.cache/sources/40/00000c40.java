...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (this.mReparent) {
            ...
            transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0487R.C0488id.transition_transform));
            transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0487R.C0488id.parent_matrix));
        }
    }
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0487R.C0488id.parent_matrix, endParentMatrix);
    ...
    public static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0487R.C0488id.transition_transform, null);
            this.mView.setTag(C0487R.C0488id.parent_matrix, null);
        }
    ...
    public static class Listener extends AnimatorListenerAdapter {
        ...
        private void setCurrentMatrix(Matrix currentMatrix) {
            ...
            this.mView.setTag(C0487R.C0488id.transition_transform, this.mTempMatrix);
            this.mTransforms.restore(this.mView);
        }
    }
}