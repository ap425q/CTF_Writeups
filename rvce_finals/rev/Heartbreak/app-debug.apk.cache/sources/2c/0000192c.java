...
public class LockFreeLinkedListNode {
    ...
    /* compiled from: LockFreeLinkedList.kt */
    @Metadata(m29d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\b!\u0018\u00002\f\u0012\b\u0012\u00060\u0002j\u0002`\u00030\u0001B\u0011\u0012\n\u0010\u0004\u001a\u00060\u0002j\u0002`\u0003¢\u0006\u0002\u0010\u0005J\u001e\u0010\u0007\u001a\u00020\b2\n\u0010\t\u001a\u00060\u0002j\u0002`\u00032\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0016R\u0014\u0010\u0004\u001a\u00060\u0002j\u0002`\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0006\u001a\n\u0018\u00010\u0002j\u0004\u0018\u0001`\u00038\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\f"}, m28d2 = {"Lkotlinx/coroutines/internal/LockFreeLinkedListNode$CondAddOp;", "Lkotlinx/coroutines/internal/AtomicOp;", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "Lkotlinx/coroutines/internal/Node;", "newNode", "(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V", "oldNext", "complete", "", "affected", "failure", "", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode affected, Object failure) {
            ...
            if (update != null && C0137xc40028dd.m169m(LockFreeLinkedListNode._next$FU, affected, this, update) && success) {
    ...
    public final CondAddOp makeCondAddOp(LockFreeLinkedListNode node, Functions<Boolean> functions) {
        return new LockFreeLinkedListNode$makeCondAddOp$1(node, functions);
    }
    ...
    */
    public final boolean addOneIfEmpty(kotlinx.coroutines.internal.LockFreeLinkedListNode r3) {
        ...
        L13:
            ...
            boolean r1 = androidx.concurrent.futures.C0137xc40028dd.m169m(r1, r2, r2, r3)
            if (r1 == 0) goto La
            r3.finishAdd(r2)
            r1 = 1
            return r1
    ...
    public final boolean addLastIf(LockFreeLinkedListNode node, Functions<Boolean> functions) {
        CondAddOp condAdd = new LockFreeLinkedListNode$makeCondAddOp$1(node, functions);
        while (true) {
    ...
    public final boolean addLastIfPrevAndIf(LockFreeLinkedListNode node, Function1<? super LockFreeLinkedListNode, Boolean> function1, Functions<Boolean> functions) {
        CondAddOp condAdd = new LockFreeLinkedListNode$makeCondAddOp$1(node, functions);
        while (true) {
            LockFreeLinkedListNode prev = getPrevNode();
            if (function1.invoke(prev).booleanValue()) {
    ...
    public final boolean addNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next) {
        ...
        if (C0137xc40028dd.m169m(_next$FU, this, next, node)) {
            node.finishAdd(next);
            return true;
        }
        return false;
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next, CondAddOp condAdd) {
        ...
        if (C0137xc40028dd.m169m(_next$FU, this, next, condAdd)) {
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!C0137xc40028dd.m169m(_next$FU, this, next, removed));
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            C0137xc40028dd.m169m(_affectedNode$FU, this, null, prepareOp.affected);
        }

        @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode.AbstractAtomicDesc
        public Object updatedNext(LockFreeLinkedListNode affected, LockFreeLinkedListNode next) {
            C0137xc40028dd.m169m(LockFreeLinkedListNode._prev$FU, this.node, this.node, affected);
            C0137xc40028dd.m169m(LockFreeLinkedListNode._next$FU, this.node, this.node, this.queue);
            return this.node;
        }
    ...
    public static class RemoveFirstDesc<T> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            C0137xc40028dd.m169m(_affectedNode$FU, this, null, prepareOp.affected);
            C0137xc40028dd.m169m(_originalNext$FU, this, null, prepareOp.next);
        }
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            if (decision == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                ...
                if (C0137xc40028dd.m169m(LockFreeLinkedListNode._next$FU, (LockFreeLinkedListNode) affected, this, removed)) {
            ...
            C0137xc40028dd.m169m(LockFreeLinkedListNode._next$FU, (LockFreeLinkedListNode) affected, this, update);
            return null;
        }
    ...
    public static abstract class AbstractAtomicDesc extends Atomic {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:29:0x005c, code lost:
            if (kotlinx.coroutines.Debug.getASSERTIONS_ENABLED() == false) goto L33;
         */
        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r9) {
            ...
            L39:
                ...
                boolean r5 = androidx.concurrent.futures.C0137xc40028dd.m169m(r5, r0, r1, r4)
                if (r5 == 0) goto L1
            L50:
                ...
                if (r5 == r6) goto L1
                boolean r6 = kotlinx.coroutines.Debug.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L6e
                if (r6 == 0) goto L6d
                r6 = 0
                if (r5 != 0) goto L63
                r7 = 1
            ...
            L6e:
                r2 = move-exception
                java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = kotlinx.coroutines.internal.LockFreeLinkedListNode._next$FU
                androidx.concurrent.futures.C0137xc40028dd.m169m(r5, r0, r4, r1)
                throw r2
            */
        ...
        public final void complete(AtomicOp<?> atomicOp, Object failure) {
            ...
            if (C0137xc40028dd.m169m(LockFreeLinkedListNode._next$FU, affectedNode, atomicOp, update) && success) {
    ...
    public final void finishAdd(LockFreeLinkedListNode next) {
        ...
        } while (!C0137xc40028dd.m169m(_prev$FU, next, nextPrev, this));
        if (isRemoved()) {
            next.correctPrev(null);
        }
    }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (prevNext == this) {
                    ...
                    if (C0137xc40028dd.m169m(_prev$FU, this, oldPrev, prev)) {
                        return prev;
                    }
                } else if (isRemoved()) {
                    return null;
                    ...
                    if (prevNext instanceof OpDescriptor) {
                        ...
                        if (last != null) {
                            if (!C0137xc40028dd.m169m(_next$FU, last, prev, ((Removed) prevNext).ref)) {
                                break;
                            }
                            prev = last;
                            last = null;
