...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static /* synthetic */ void $r8$lambda$EVyYoVT11DpL60suE9bxns8qbCM(CarouselLayoutManager carouselLayoutManager) {
    ...
    public /* synthetic */ void m117x2ff337cb(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        if (left != oldLeft || top != oldTop || right != oldRight || bottom != oldBottom) {
            v.post(new Runnable() { // from class: com.google.android.material.carousel.CarouselLayoutManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    CarouselLayoutManager.$r8$lambda$EVyYoVT11DpL60suE9bxns8qbCM(CarouselLayoutManager.this);
                }
            });
        }
    }
    ...
    public CarouselLayoutManager(CarouselStrategy strategy, int orientation) {
        ...
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.CarouselLayoutManager$$ExternalSyntheticLambda1
            ...
            public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                CarouselLayoutManager.this.m117x2ff337cb(view, i, i2, i3, i4, i5, i6, i7, i8);
            }
        };
    ...
    private void setCarouselAttributes(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0558R.styleable.Carousel);
            setCarouselAlignment(a.getInt(C0558R.styleable.Carousel_carousel_alignment, 0));
            setOrientation(a.getInt(C0558R.styleable.RecyclerView_android_orientation, 0));
            a.recycle();
        }
    }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: com.google.android.material.carousel.CarouselLayoutManager.1
            {
                CarouselLayoutManager.this = this;
            }
    ...
    public static class DebugItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
            ...
            this.linePaint.setStrokeWidth(parent.getResources().getDimension(C0558R.dimen.m3_carousel_debug_keyline_width));
