...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        LockFreeLinkedListNode.CondAddOp condAdd$iv = new LockFreeLinkedListNode.CondAddOp(receive) { // from class: kotlinx.coroutines.channels.AbstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1
    ...
    */
    public final java.lang.Object mo1724receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r6) {
        /*
            r5 = this;
        ...
        L32:
            ...
            java.lang.Object r3 = r3.m1744closedJP2dKIU(r4)
            goto L56
        L50:
            kotlinx.coroutines.channels.ChannelResult$Companion r3 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r3 = r3.m1746successJP2dKIU(r1)
        L56:
            return r3
        L57:
            r3 = 1
        ...
        L61:
            ...
            java.lang.Object r1 = r2.m1743unboximpl()
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1724receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public final Object mo1725tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1745failurePtdJZtk() : result instanceof Closed ? ChannelResult.Companion.m1744closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.Companion.m1746successJP2dKIU(result);
    }
    ...
    public final void cancel(CancellationException cause) {
        ...
        cancel(cause == null ? new CancellationException(DebugStrings.getClassSimpleName(this) + " was cancelled") : cause);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1764constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode previous = closed.getPrevNode();
            if (!(previous instanceof LockFreeLinkedListHead)) {
                if (Debug.getASSERTIONS_ENABLED() && !(previous instanceof Send)) {
                    throw new AssertionError();
                }
                if (!previous.mo1772remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1769plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1723onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    protected void mo1723onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
        if (value instanceof Closed) {
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        Undispatched.startCoroutineUnintercepted(function2, ChannelResult.m1731boximpl(ChannelResult.Companion.m1744closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
            ...
            Object $this$toResult$iv = ChannelResult.m1731boximpl(value instanceof Closed ? ChannelResult.Companion.m1744closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.Companion.m1746successJP2dKIU(value));
    ...
    public final void removeReceiveOnCancel(CancellableContinuation<?> cancellableContinuation, Receive<?> receive) {
        CompletionHandler $this$asHandler$iv = new RemoveReceiveOnCancel(receive);
        cancellableContinuation.invokeOnCancellation($this$asHandler$iv);
    }

    /* compiled from: AbstractChannel.kt */
    @Metadata(m29d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0011\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003¢\u0006\u0002\u0010\u0004J\u0013\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0096\u0002J\b\u0010\t\u001a\u00020\nH\u0016R\u0012\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m28d2 = {"Lkotlinx/coroutines/channels/AbstractChannel$RemoveReceiveOnCancel;", "Lkotlinx/coroutines/BeforeResumeCancelHandler;", "receive", "Lkotlinx/coroutines/channels/Receive;", "(Lkotlinx/coroutines/channels/AbstractChannel;Lkotlinx/coroutines/channels/Receive;)V", "invoke", "", "cause", "", "toString", "", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m221constructorimpl(boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m221constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
                } else if (result != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean = boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
                    cont.resume(boxBoolean, function1 != null ? OnUndeliveredElement.bindCancellationFun(function1, result, cont.getContext()) : null);
                }
            }
            Object result2 = cancellable$iv.getResult();
            if (result2 == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1731boximpl(ChannelResult.Companion.m1746successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m221constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            ChannelResult m1731boximpl = ChannelResult.m1731boximpl(ChannelResult.Companion.m1744closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m221constructorimpl(m1731boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            Cancellable.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1731boximpl(ChannelResult.Companion.m1746successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        Cancellable.startCoroutineCancellable$default(this.block, ChannelResult.m1731boximpl(ChannelResult.Companion.m1744closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        return;
                    default:
                        return;
                }
