...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final Object finalizeFinishingState(Finishing state, Object proposedUpdate) {
        ...
        if (Debug.getASSERTIONS_ENABLED() && (!state.isSealed()) == 0) {
            throw new AssertionError();
        }
        if (!Debug.getASSERTIONS_ENABLED() || state.isCompleting()) {
            ...
            boolean casSuccess = C0137xc40028dd.m169m(_state$FU, this, state, JobSupportKt.boxIncomplete(finalState));
            if (!Debug.getASSERTIONS_ENABLED() || casSuccess) {
    ...
    private final Throwable getFinalRootCause(Finishing state, List<? extends Throwable> list) {
        ...
        if (first instanceof Timeout) {
            ...
            while (true) {
                ...
                if (it4 == first || !(it4 instanceof Timeout)) {
                    it = null;
                    continue;
                } else {
                    it = 1;
    ...
    private final void addSuppressedExceptions(Throwable rootCause, List<? extends Throwable> list) {
        ...
        Throwable unwrappedCause = !Debug.getRECOVER_STACK_TRACES() ? rootCause : StackTraceRecovery.unwrapImpl(rootCause);
        for (Throwable exception : list) {
            Throwable unwrapped = !Debug.getRECOVER_STACK_TRACES() ? exception : StackTraceRecovery.unwrapImpl(exception);
            if (unwrapped != rootCause && unwrapped != unwrappedCause && !(unwrapped instanceof CancellationException) && seenExceptions.add(unwrapped)) {
                Exceptions.addSuppressed(rootCause, unwrapped);
            }
        }
    }
    ...
    private final boolean tryFinalizeSimpleState(Incomplete state, Object update) {
        ...
        if (Debug.getASSERTIONS_ENABLED() && (!(update instanceof CompletedExceptionally)) == 0) {
            throw new AssertionError();
        }
        if (C0137xc40028dd.m169m(_state$FU, this, state, JobSupportKt.boxIncomplete(update))) {
            onCancelling(null);
            ...
            if (cur$iv$iv instanceof JobCancellingNode) {
                ...
                try {
                    ...
                    if ($this$notifyHandlers_u24lambda_u2d14_u24lambda_u2d12$iv != null) {
                        Exceptions.addSuppressed($this$notifyHandlers_u24lambda_u2d14_u24lambda_u2d12$iv, ex$iv);
                        if ($this$notifyHandlers_u24lambda_u2d14_u24lambda_u2d12$iv != null) {
                        }
                    }
            ...
            if (cur$iv instanceof LockFreeLinkedListNode) {
                ...
                try {
                    ...
                    if (th != null) {
                        ...
                        Exceptions.addSuppressed($this$notifyHandlers_u24lambda_u2d14_u24lambda_u2d12, ex);
                        if (th != null) {
                        }
                    }
    ...
    private final int startInternal(Object state) {
        ...
        if (state instanceof Empty) {
            ...
            if (C0137xc40028dd.m169m(atomicReferenceFieldUpdater, this, state, empty)) {
                onStart();
                return 1;
            }
            return -1;
        } else if (state instanceof InactiveNodeList) {
            if (C0137xc40028dd.m169m(_state$FU, this, state, ((InactiveNodeList) state).getList())) {
                onStart();
                return 1;
            }
            return -1;
    ...
    public final CancellationException getCancellationException() {
        ...
        if (!(state instanceof Finishing)) {
            ...
            return state instanceof CompletedExceptionally ? toCancellationException$default(this, ((CompletedExceptionally) state).cause, null, 1, null) : new JobCancellationException(DebugStrings.getClassSimpleName(this) + " has completed normally", null, this);
        }
    ...
    public final DisposableHandle invokeOnCompletion(boolean onCancelling, boolean invokeImmediately, Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (state instanceof Empty) {
                if (((Empty) state).isActive()) {
                    if (C0137xc40028dd.m169m(_state$FU, this, state, node)) {
                        return node;
                    }
                } else {
    ...
    private final JobNode makeNode(Function1<? super Throwable, Unit> function1, boolean onCancelling) {
        ...
        if (onCancelling) {
            ...
            if (node != null) {
                JobNode it = node;
                if (Debug.getASSERTIONS_ENABLED() && (!(it instanceof JobCancellingNode)) == 0) {
                    throw new AssertionError();
                }
            } else {
    ...
    private final void promoteEmptyToNodeList(Empty state) {
        ...
        C0137xc40028dd.m169m(_state$FU, this, state, update);
    }
    ...
    private final void promoteSingleToNodeList(JobNode state) {
        ...
        C0137xc40028dd.m169m(_state$FU, this, state, list);
    }
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode node) {
        ...
        } while (!C0137xc40028dd.m169m(atomicReferenceFieldUpdater, this, state, empty));
    }
    ...
    private final boolean tryMakeCancelling(Incomplete state, Throwable rootCause) {
        if (Debug.getASSERTIONS_ENABLED() && (!(state instanceof Finishing)) == 0) {
            throw new AssertionError();
        }
        if (!Debug.getASSERTIONS_ENABLED() || state.isActive()) {
            NodeList list = getOrPromoteCancellingList(state);
            if (list == null) {
                return false;
            }
            Finishing cancelling = new Finishing(list, false, rootCause);
            if (C0137xc40028dd.m169m(_state$FU, this, state, cancelling)) {
    ...
    private final Object tryMakeCompletingSlowPath(Incomplete state, Object proposedUpdate) {
        ...
        synchronized (finishing) {
            ...
            if (finishing != state && !C0137xc40028dd.m169m(_state$FU, this, state, finishing)) {
                symbol = JobSupportKt.COMPLETING_RETRY;
                return symbol;
            }
            if (Debug.getASSERTIONS_ENABLED() && (!finishing.isSealed()) == 0) {
                throw new AssertionError();
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: JobSupport.kt */
    @Metadata(m29d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0002\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\b\u0010\b\u001a\u0004\u0018\u00010\t¢\u0006\u0002\u0010\nJ\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eH\u0096\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, m28d2 = {"Lkotlinx/coroutines/JobSupport$ChildCompletion;", "Lkotlinx/coroutines/JobNode;", "parent", "Lkotlinx/coroutines/JobSupport;", "state", "Lkotlinx/coroutines/JobSupport$Finishing;", "child", "Lkotlinx/coroutines/ChildHandleNode;", "proposedUpdate", "", "(Lkotlinx/coroutines/JobSupport;Lkotlinx/coroutines/JobSupport$Finishing;Lkotlinx/coroutines/ChildHandleNode;Ljava/lang/Object;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: JobSupport.kt */
    @Metadata(m29d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001b\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\rH\u0014R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, m28d2 = {"Lkotlinx/coroutines/JobSupport$AwaitContinuation;", "T", "Lkotlinx/coroutines/CancellableContinuationImpl;", "delegate", "Lkotlin/coroutines/Continuation;", "job", "Lkotlinx/coroutines/JobSupport;", "(Lkotlin/coroutines/Continuation;Lkotlinx/coroutines/JobSupport;)V", "getContinuationCancellationCause", "", "parent", "Lkotlinx/coroutines/Job;", "nameString", "", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
            ...
            if (!(state instanceof Incomplete)) {
                if (selectInstance.trySelect()) {
                    if (state instanceof CompletedExceptionally) {
                        ...
                        Undispatched.startCoroutineUnintercepted(function2, JobSupportKt.unboxState(state), selectInstance.getCompletion());
                        return;
                    }
                }
                return;
    ...
    public final <T, R> void selectAwaitCompletion$kotlinx_coroutines_core(SelectInstance<? super R> selectInstance, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        ...
        if (state instanceof CompletedExceptionally) {
            ...
            Cancellable.startCoroutineCancellable$default(function2, JobSupportKt.unboxState(state), selectInstance.getCompletion(), null, 4, null);
        }
    }
}