...
public final class DurationKt {
    ...
    private static final long m1673timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1585timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1672timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1584timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
            ...
            if (!($this$all$iv2 instanceof Collection) || !((Collection) $this$all$iv2).isEmpty()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (!new PrimitiveRanges('0', '9').contains(value.charAt(element$iv))) {
                            $this$all$iv = null;
                            break;
                        }
                    } else {
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1547constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1547constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1547constructorimpl((normalValue << 1) + unitDiscriminator);
    }
