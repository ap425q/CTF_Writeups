...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0028R.C0031id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0028R.C0031id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0028R.C0031id.submenuarrow);
    ...
    private void insertIconView() {
        ...
        this.mIconView = (ImageView) inflater.inflate(C0028R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
        addContentView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        this.mRadioButton = (RadioButton) inflater.inflate(C0028R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
        addContentView(this.mRadioButton);
    }

    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        this.mCheckBox = (CheckBox) inflater.inflate(C0028R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
