...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public final boolean resetStateReusable() {
        ...
        if (Debug.getASSERTIONS_ENABLED() && (!(state instanceof NotCompleted)) == 0) {
            throw new AssertionError();
        }
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        while (true) {
            ...
            if (!(state instanceof CompletedContinuation)) {
                if (C0137xc40028dd.m169m(_state$FU, this, state, new CompletedContinuation(state, null, null, null, cause, 14, null))) {
                    return;
                }
    ...
    public boolean cancel(Throwable cause) {
        Object state;
        CompletionState update;
        do {
            state = this._state;
            if (!(state instanceof NotCompleted)) {
                return false;
            }
            update = new CompletionState(this, cause, state instanceof CancelHandler);
    ...
    public final Object getResult() {
        ...
        if (!(state instanceof CompletedExceptionally)) {
            if (DispatchedTaskKt.isCancellableMode(this.resumeMode) && (job = (Job) getContext().get(Job.Key)) != null && !job.isActive()) {
                ...
                if (!Debug.getRECOVER_STACK_TRACES() || !(this instanceof CoroutineStackFrame)) {
                    throw cause;
                }
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (state instanceof Active) {
                if (C0137xc40028dd.m169m(_state$FU, this, state, cancelHandler)) {
                    return;
                }
                ...
                if (state instanceof CompletionState) {
                ...
                if (C0137xc40028dd.m169m(_state$FU, this, state, update2)) {
                    return;
                }
            }
        }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> function1) {
        ...
        do {
            ...
            } else if ((state instanceof CompletionState) && ((CompletionState) state).makeResumed()) {
                if (function1 != null) {
                    callOnCancellation(function1, ((CompletionState) state).cause);
                    return;
                }
                return;
            } else {
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> function1) {
        ...
        do {
            ...
            if (state instanceof NotCompleted) {
                ...
                if (!Debug.getASSERTIONS_ENABLED() || Intrinsics.areEqual(((CompletedContinuation) state).result, proposedUpdate)) {
