...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object $this$toResult) {
        return $this$toResult instanceof Closed ? ChannelResult.Companion.m1744closedJP2dKIU(((Closed) $this$toResult).closeCause) : ChannelResult.Companion.m1746successJP2dKIU($this$toResult);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m1744closedJP2dKIU(closed.closeCause);
    }
}