...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f57x;
        start.top = this.mStartMotionPath.f58y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f57x;
        end.top = this.mEndMotionPath.f58y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f57x - this.mStartMotionPath.f57x;
        float dy = this.mEndMotionPath.f58y - this.mStartMotionPath.f58y;
        float startCenterX = this.mStartMotionPath.f57x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f58y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (points[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                ...
                values[i9][0] = points[i9].f57x;
                values[i9][1] = points[i9].f58y;
            }
    ...
    */
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f57x - this.mStartMotionPath.f57x;
        float dTop = this.mEndMotionPath.f58y - this.mStartMotionPath.f58y;
