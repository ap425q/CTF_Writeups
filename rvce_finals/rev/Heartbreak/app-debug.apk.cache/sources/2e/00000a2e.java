...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0364Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0364Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0364Op(int cmd, Fragment fragment, boolean fromExpandedOp) {
            this.mCmd = cmd;
            this.mFragment = fragment;
        ...
        C0364Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
    ...
    public FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction ft) {
        ...
        Iterator<C0364Op> it = ft.mOps.iterator();
        while (it.hasNext()) {
            C0364Op op = it.next();
            this.mOps.add(new C0364Op(op));
        }
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0364Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0364Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0364Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0364Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0364Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0364Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0364Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0364Op(10, fragment, state));
        return this;
    }
