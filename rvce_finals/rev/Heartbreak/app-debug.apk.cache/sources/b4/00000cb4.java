...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        if ((this.mMode & 2) == 2 && startValues != null) {
            ...
            View savedOverlayView = (View) startView.getTag(C0487R.C0488id.save_overlay_view);
            ...
            if (overlayView != null) {
                ...
                if (!reusingOverlayView) {
                    if (animator == null) {
                        ...
                        startView.setTag(C0487R.C0488id.save_overlay_view, overlayView);
    ...
    public class OverlayListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onAnimationStart(Animator animation, boolean isReverse) {
            if (isReverse) {
                this.mStartView.setTag(C0487R.C0488id.save_overlay_view, this.mOverlayView);
                this.mOverlayHost.getOverlay().add(this.mOverlayView);
        ...
        private void removeFromOverlay() {
            this.mStartView.setTag(C0487R.C0488id.save_overlay_view, null);
            this.mOverlayHost.getOverlay().remove(this.mOverlayView);
