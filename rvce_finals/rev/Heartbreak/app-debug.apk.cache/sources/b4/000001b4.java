...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setBackground(a.getDrawable(C0028R.styleable.ActionMode_background));
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0028R.C0031id.action_bar_title);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mCloseButton = this.mClose.findViewById(C0028R.C0031id.action_mode_close_button);
