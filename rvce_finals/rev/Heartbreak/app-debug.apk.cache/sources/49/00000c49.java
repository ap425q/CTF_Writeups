...
public class Fade extends Visibility {
    ...
    /* renamed from: IN */
    public static final int f104IN = 1;
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        Float alpha = (Float) transitionValues.view.getTag(C0487R.C0488id.transition_pause_alpha);
        if (alpha == null) {
    ...
    public static class FadeAnimatorListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionPause(Transition transition) {
            ...
            this.mView.setTag(C0487R.C0488id.transition_pause_alpha, Float.valueOf(pauseAlpha));
        }

        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionResume(Transition transition) {
            this.mView.setTag(C0487R.C0488id.transition_pause_alpha, null);
        }
    }
}