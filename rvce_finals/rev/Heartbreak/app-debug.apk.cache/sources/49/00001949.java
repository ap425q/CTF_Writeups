...
public final class StackTraceRecovery {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m221constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m221constructorimpl(ResultKt.createFailure(th));
        }
        ...
        try {
            ...
            obj2 = Result.m221constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m221constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m224exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
    ...
    public static final <E extends Throwable> E recoverStackTrace(E e) {
        Throwable copy;
        return (Debug.getRECOVER_STACK_TRACES() && (copy = tryCopyAndVerify(e)) != null) ? (E) sanitizeStackTrace(copy) : e;
    }
    ...
    private static final <E extends Throwable> Tuples<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            if (z) {
                return TuplesKt.m21to(cause, currentTrace);
            }
            return TuplesKt.m21to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m21to(e, new StackTraceElement[0]);
    }
