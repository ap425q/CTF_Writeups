...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public boolean offer(E e) {
        ...
        try {
            ...
            if (function1 != null && (it = OnUndeliveredElement.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
                Exceptions.addSuppressed(it, e2);
                throw it;
            }
            throw e2;
        }
    ...
    public final Object mo1726trySendJP2dKIU(E e) {
        Object result = offerInternal(e);
        if (result == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m1746successJP2dKIU(Unit.INSTANCE);
        }
        if (result == AbstractChannelKt.OFFER_FAILED) {
            Closed closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m1745failurePtdJZtk() : ChannelResult.Companion.m1744closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (result instanceof Closed) {
            return ChannelResult.Companion.m1744closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        } else {
    ...
    private final Throwable helpCloseAndGetSendException(E e, Closed<?> closed) {
        ...
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        if (function1 != null && (it = OnUndeliveredElement.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            Exceptions.addSuppressed(it, closed.getSendException());
            throw it;
        }
        return closed.getSendException();
    }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerResult == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                cont.resumeWith(Result.m221constructorimpl(Unit.INSTANCE));
                break;
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        if (function1 != null && (it = OnUndeliveredElement.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            Exceptions.addSuppressed(it, sendException);
            Result.Companion companion = Result.Companion;
            continuation.resumeWith(Result.m221constructorimpl(ResultKt.createFailure(it)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m221constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    */
    ...
    private final void invokeOnCloseHandler(Throwable cause) {
        ...
        if (handler != null && handler != AbstractChannelKt.HANDLER_INVOKED && C0137xc40028dd.m169m(onCloseHandler$FU, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        if (!C0137xc40028dd.m169m(onCloseHandler$FU, this, null, function1)) {
        ...
        if (closedToken != null && C0137xc40028dd.m169m(onCloseHandler$FU, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
            function1.invoke(closedToken.closeCause);
        }
    }

    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1764constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1772remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1769plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
    ...
    /* compiled from: AbstractChannel.kt */
    @Metadata(m29d1 = {"\u00006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u00030\u0002j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u0003`\u0004B\u0015\u0012\u0006\u0010\u0005\u001a\u00028\u0001\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0012\u0010\n\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0014J\u0016\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\n\u0010\u000f\u001a\u00060\u0010j\u0002`\u0011H\u0016R\u0012\u0010\u0005\u001a\u00028\u00018\u0006X\u0087\u0004¢\u0006\u0004\n\u0002\u0010\t¨\u0006\u0012"}, m28d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$TryOfferDesc;", "E", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/ReceiveOrClosed;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "element", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Ljava/lang/Object;Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "Ljava/lang/Object;", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
        ...
        while (!selectInstance.isSelected()) {
            if (isFullImpl()) {
                ...
                if (enqueueResult == null) {
                    ...
                    throw StackTraceRecovery.recoverStackTrace(helpCloseAndGetSendException(e, (Closed) enqueueResult));
                } else {
            ...
            if (offerResult != AbstractChannelKt.OFFER_FAILED && offerResult != AtomicKt.RETRY_ATOMIC) {
                if (offerResult == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    throw StackTraceRecovery.recoverStackTrace(helpCloseAndGetSendException(e, (Closed) offerResult));
                }
            }
        }
    }
    ...
    /* compiled from: AbstractChannel.kt */
    @Metadata(m29d1 = {"\u00006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u0000*\u0006\b\u0001\u0010\u0001 \u00012\u00020\u0002B\r\u0012\u0006\u0010\u0003\u001a\u00028\u0001¢\u0006\u0002\u0010\u0004J\b\u0010\n\u001a\u00020\u000bH\u0016J\u0014\u0010\f\u001a\u00020\u000b2\n\u0010\r\u001a\u0006\u0012\u0002\b\u00030\u000eH\u0016J\b\u0010\u000f\u001a\u00020\u0010H\u0016J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0014H\u0016R\u0012\u0010\u0003\u001a\u00028\u00018\u0006X\u0087\u0004¢\u0006\u0004\n\u0002\u0010\u0005R\u0016\u0010\u0006\u001a\u0004\u0018\u00010\u00078VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\b\u0010\t¨\u0006\u0015"}, m28d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$SendBuffered;", "E", "Lkotlinx/coroutines/channels/Send;", "element", "(Ljava/lang/Object;)V", "Ljava/lang/Object;", "pollResult", "", "getPollResult", "()Ljava/lang/Object;", "completeResumeSend", "", "resumeSendClosed", "closed", "Lkotlinx/coroutines/channels/Closed;", "toString", "", "tryResumeSend", "Lkotlinx/coroutines/internal/Symbol;", "otherOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "kotlinx-coroutines-core"}, m27k = 1, m26mv = {1, 6, 0}, m24xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
