    ...
    public static final byte[] readBytes(File $this$readBytes) {
        ...
        try {
            ...
            if (remaining > 0) {
                ...
                if (extraByte != -1) {
                    FileReadWrite extra = new FileReadWrite(8193);
