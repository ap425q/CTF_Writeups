...
public final class CoroutineExceptionHandlerKt {
    public static final void handleCoroutineException(CoroutineContext context, Throwable exception) {
        try {
            ...
            if (it != null) {
                ...
                CoroutineExceptionHandlerImpl.handleCoroutineExceptionImpl(context, exception);
            }
        } catch (Throwable t) {
            CoroutineExceptionHandlerImpl.handleCoroutineExceptionImpl(context, handlerException(exception, t));
        }
    }
    ...
    public static final Throwable handlerException(Throwable originalException, Throwable thrownException) {
        ...
        Exceptions.addSuppressed($this$addSuppressedThrowable$iv, originalException);
