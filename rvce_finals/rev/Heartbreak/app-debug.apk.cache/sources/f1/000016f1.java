...
public final class TimeoutKt {
    ...
    public static final <T> Object m1719withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1711toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    */
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L2e:
            ...
            kotlin.ResultKt.throwOnFailure(r0)     // Catch: kotlinx.coroutines.Timeout -> L3d
            r8 = r0
            goto L78
        L3d:
            r8 = move-exception
        ...
        L49:
            ...
            r2.<init>()
            r10.L$0 = r9     // Catch: kotlinx.coroutines.Timeout -> L79
            r10.L$1 = r2     // Catch: kotlinx.coroutines.Timeout -> L79
            r10.J$0 = r7     // Catch: kotlinx.coroutines.Timeout -> L79
            r4 = 1
            r10.label = r4     // Catch: kotlinx.coroutines.Timeout -> L79
            r4 = r10
            kotlin.coroutines.Continuation r4 = (kotlin.coroutines.Continuation) r4     // Catch: kotlinx.coroutines.Timeout -> L79
            r5 = 0
            kotlinx.coroutines.TimeoutCoroutine r6 = new kotlinx.coroutines.TimeoutCoroutine     // Catch: kotlinx.coroutines.Timeout -> L79
            r6.<init>(r7, r4)     // Catch: kotlinx.coroutines.Timeout -> L79
            r7 = r6
            r2.element = r7     // Catch: kotlinx.coroutines.Timeout -> L79
            java.lang.Object r8 = setupTimeout(r7, r9)     // Catch: kotlinx.coroutines.Timeout -> L79
            java.lang.Object r7 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch: kotlinx.coroutines.Timeout -> L79
            if (r8 != r7) goto L74
            r7 = r10
            kotlin.coroutines.Continuation r7 = (kotlin.coroutines.Continuation) r7     // Catch: kotlinx.coroutines.Timeout -> L79
            kotlin.coroutines.jvm.internal.DebugProbes.probeCoroutineSuspended(r7)     // Catch: kotlinx.coroutines.Timeout -> L79
        L74:
            if (r8 != r1) goto L77
            return r1
        L77:
    ...
    public static final <T> Object m1720withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1711toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    public static final Timeout TimeoutCancellationException(long time, Job coroutine) {
        return new Timeout("Timed out waiting for " + time + " ms", coroutine);
    }
}