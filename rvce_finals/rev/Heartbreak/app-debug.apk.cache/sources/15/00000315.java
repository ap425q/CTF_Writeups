...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    void different(MotionConstrainedPoint points, boolean[] mask, String[] custom) {
        ...
        int c2 = c + 1;
        mask[c] = mask[c] | diff(this.f19x, points.f19x);
        int c3 = c2 + 1;
        mask[c2] = mask[c2] | diff(this.f20y, points.f20y);
        int c4 = c3 + 1;
    ...
    void fillStandard(double[] data, int[] toUse) {
        float[] set = {this.position, this.f19x, this.f20y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int c = 0;
