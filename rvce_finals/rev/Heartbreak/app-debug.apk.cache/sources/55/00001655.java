...
public final /* synthetic */ class BuildersKt__Builders_commonKt {
    ...
    public static final Job launch(CoroutineScope $this$launch, CoroutineContext context, CoroutineStart start, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        CoroutineContext newContext = CoroutineContext.newCoroutineContext($this$launch, context);
        if (start.isLazy()) {
    ...
    public static final <T> Deferred<T> async(CoroutineScope $this$async, CoroutineContext context, CoroutineStart start, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CoroutineContext newContext = CoroutineContext.newCoroutineContext($this$async, context);
        if (start.isLazy()) {
    ...
    public static final <T> Object withContext(CoroutineContext context, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        CoroutineContext newContext = CoroutineContext.newCoroutineContext(oldContext, context);
        JobKt.ensureActive(newContext);
        if (newContext == oldContext) {
            ScopeCoroutine coroutine = new ScopeCoroutine(newContext, continuation);
            result = Undispatched.startUndispatchedOrReturn(coroutine, coroutine, function2);
            ...
            Object oldValue$iv = ThreadContext.updateThreadContext(newContext, null);
            try {
                Object startUndispatchedOrReturn = Undispatched.startUndispatchedOrReturn(coroutine2, coroutine2, function2);
                ThreadContext.restoreThreadContext(newContext, oldValue$iv);
            ...
            Cancellable.startCoroutineCancellable$default(function2, coroutine3, coroutine3, null, 4, null);
