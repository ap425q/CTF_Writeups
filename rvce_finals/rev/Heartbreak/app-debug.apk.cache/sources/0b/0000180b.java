    ...
    */
    public static final <T> java.lang.Object catchImpl(kotlinx.coroutines.flow.Flow<? extends T> r5, kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super java.lang.Throwable> r7) {
        ...
        L71:
            ...
            if (r1 == 0) goto L79
            kotlin.Exceptions.addSuppressed(r5, r6)
            throw r5
        L79:
            kotlin.Exceptions.addSuppressed(r6, r5)
            throw r6
        L7d:
            throw r6
        */
    ...
    private static final boolean isSameExceptionAs$FlowKt__ErrorsKt(Throwable $this$isSameExceptionAs, Throwable other) {
        if (other != null) {
            if (Intrinsics.areEqual(!Debug.getRECOVER_STACK_TRACES() ? other : StackTraceRecovery.unwrapImpl(other), !Debug.getRECOVER_STACK_TRACES() ? $this$isSameExceptionAs : StackTraceRecovery.unwrapImpl($this$isSameExceptionAs))) {
                return true;
            }
        }
        return false;
