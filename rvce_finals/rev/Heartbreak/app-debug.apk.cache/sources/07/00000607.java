...
public final class Bitmap {
    ...
    public static /* synthetic */ android.graphics.Bitmap scale$default(android.graphics.Bitmap $this$scale_u24default, int width, int height, boolean filter, int i, Object obj) {
        ...
        return android.graphics.Bitmap.createScaledBitmap($this$scale_u24default, width, height, filter);
    }

    public static final android.graphics.Bitmap scale(android.graphics.Bitmap $this$scale, int width, int height, boolean filter) {
        return android.graphics.Bitmap.createScaledBitmap($this$scale, width, height, filter);
    }
    ...
    public static /* synthetic */ android.graphics.Bitmap createBitmap$default(int width, int height, Bitmap.Config config, boolean hasAlpha, ColorSpace colorSpace, int i, Object obj) {
        ...
        return android.graphics.Bitmap.createBitmap(width, height, config, hasAlpha, colorSpace);
    }
