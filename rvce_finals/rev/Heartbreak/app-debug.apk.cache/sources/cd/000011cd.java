...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, null, C0558R.attr.materialTimePickerStyle, C0558R.style.Widget_MaterialComponents_TimePicker);
        TypedArray a = context.obtainStyledAttributes(null, C0558R.styleable.MaterialTimePicker, C0558R.attr.materialTimePickerStyle, C0558R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = a.getResourceId(C0558R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = a.getResourceId(C0558R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int backgroundColor = a.getColor(C0558R.styleable.MaterialTimePicker_backgroundTint, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup root = (ViewGroup) layoutInflater.inflate(C0558R.layout.material_timepicker_dialog, viewGroup);
        this.timePickerView = (TimePickerView) root.findViewById(C0558R.C0561id.material_timepicker_view);
        this.timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) root.findViewById(C0558R.C0561id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) root.findViewById(C0558R.C0561id.material_timepicker_mode_button);
        TextView headerTitle = (TextView) root.findViewById(C0558R.C0561id.header_title);
        ...
        Button okButton = (Button) root.findViewById(C0558R.C0561id.material_timepicker_ok_button);
        ...
        this.cancelButton = (Button) root.findViewById(C0558R.C0561id.material_timepicker_cancel_button);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialTimePicker.this.m33xac73da03();
                }
            }, 100L);
        }
    }
    ...
    public /* synthetic */ void m33xac73da03() {
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
    ...
    private Pair<Integer, Integer> dataForMode(int mode) {
        switch (mode) {
            case 0:
                return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0558R.string.material_timepicker_text_input_mode_description));
            case 1:
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0558R.string.material_timepicker_clock_mode_description));
            default:
    ...
    private int getThemeResId() {
        ...
        TypedValue value = MaterialAttributes.resolve(requireContext(), C0558R.attr.materialTimePickerTheme);
        if (value == null) {
            return 0;
        }
        return value.data;
