...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public static /* synthetic */ void $r8$lambda$DzMoV5SnItMbaZ8MiIe3Ntrgpvs(HandlerContext handlerContext, Runnable runnable) {
        m1721invokeOnTimeout$lambda3(handlerContext, runnable);
    }
    ...
    public void mo1774scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda0
                ...
                public final void dispose() {
                    HandlerContext.$r8$lambda$DzMoV5SnItMbaZ8MiIe3Ntrgpvs(HandlerContext.this, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public static final void m1721invokeOnTimeout$lambda3(HandlerContext this$0, Runnable $block) {
