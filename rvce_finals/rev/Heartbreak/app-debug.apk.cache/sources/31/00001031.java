...
public class ViewUtils {
    ...
    public static void requestFocusAndShowKeyboard(final View view, final boolean useWindowInsetsController) {
        ...
        view.post(new Runnable() { // from class: com.google.android.material.internal.ViewUtils$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ViewUtils.lambda$requestFocusAndShowKeyboard$0(view, useWindowInsetsController);
            }
        });
    }

    public static /* synthetic */ void lambda$requestFocusAndShowKeyboard$0(View view, boolean useWindowInsetsController) {
        showKeyboard(view, useWindowInsetsController);
    }
    ...
    public static void doOnApplyWindowInsets(View view, AttributeSet attrs, int defStyleAttr, int defStyleRes, final OnApplyWindowInsetsListener listener) {
        TypedArray a = view.getContext().obtainStyledAttributes(attrs, C0558R.styleable.Insets, defStyleAttr, defStyleRes);
        final boolean paddingBottomSystemWindowInsets = a.getBoolean(C0558R.styleable.Insets_paddingBottomSystemWindowInsets, false);
        final boolean paddingLeftSystemWindowInsets = a.getBoolean(C0558R.styleable.Insets_paddingLeftSystemWindowInsets, false);
        final boolean paddingRightSystemWindowInsets = a.getBoolean(C0558R.styleable.Insets_paddingRightSystemWindowInsets, false);
        a.recycle();
