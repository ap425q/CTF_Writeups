...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mDividerId = propertyMapper.mapObject("divider", C0028R.attr.divider);
            this.mDividerPaddingId = propertyMapper.mapInt("dividerPadding", C0028R.attr.dividerPadding);
            this.mMeasureWithLargestChildId = propertyMapper.mapBoolean("measureWithLargestChild", C0028R.attr.measureWithLargestChild);
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", C0028R.attr.showDividers, new IntFunction<Set<String>>() { // from class: androidx.appcompat.widget.LinearLayoutCompat.InspectionCompanion.2
                @Override // java.util.function.IntFunction
