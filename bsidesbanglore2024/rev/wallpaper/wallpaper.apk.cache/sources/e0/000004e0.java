...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f60CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f61TO = "to";
    ...
    public static MailTo parse(String uri) throws ParseException {
        ...
        mailTo.mHeaders.put(f61TO, address);
        return mailTo;
    }
    ...
    public String getTo() {
        return this.mHeaders.get(f61TO);
    }

    public String getCc() {
        return this.mHeaders.get(f60CC);
    }
