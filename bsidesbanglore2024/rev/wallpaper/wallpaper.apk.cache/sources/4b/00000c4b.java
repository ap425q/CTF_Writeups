...
public class TabLayout extends HorizontalScrollView {
    ...
    ViewPager viewPager;
    private static final int DEF_STYLE_RES = C0555R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0555R.attr.tabStyle);
    }
    ...
    */
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0555R.layout.design_layout_tab_icon, iconViewParent, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0555R.layout.design_layout_tab_text, textViewParent, false);
