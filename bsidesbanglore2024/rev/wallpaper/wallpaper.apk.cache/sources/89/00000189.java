            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                    ...
                    public Drawable createDrawableFor(ResourceManagerInternal resourceManager, Context context, int resId) {
                        if (resId == C0019R.C0021drawable.abc_cab_background_top_material) {
                            return new LayerDrawable(new Drawable[]{resourceManager.getDrawable(context, C0019R.C0021drawable.abc_cab_background_internal_bg), resourceManager.getDrawable(context, C0019R.C0021drawable.abc_cab_background_top_mtrl_alpha)});
                        }
                        if (resId == C0019R.C0021drawable.abc_ratingbar_material) {
                            return getRatingBarLayerDrawable(resourceManager, context, C0019R.dimen.abc_star_big);
                        }
                        if (resId == C0019R.C0021drawable.abc_ratingbar_indicator_material) {
                            return getRatingBarLayerDrawable(resourceManager, context, C0019R.dimen.abc_star_medium);
                        }
                        if (resId == C0019R.C0021drawable.abc_ratingbar_small_material) {
                    ...
                    private LayerDrawable getRatingBarLayerDrawable(ResourceManagerInternal resourceManager, Context context, int dimenResId) {
                        ...
                        Drawable star = resourceManager.getDrawable(context, C0019R.C0021drawable.abc_star_black_48dp);
                        Drawable halfStar = resourceManager.getDrawable(context, C0019R.C0021drawable.abc_star_half_black_48dp);
                    ...
                    public boolean tintDrawable(Context context, int resId, Drawable drawable) {
                        if (resId == C0019R.C0021drawable.abc_seekbar_track_material) {
                            LayerDrawable ld = (LayerDrawable) drawable;
                            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0019R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0019R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0019R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                            return true;
                        } else if (resId == C0019R.C0021drawable.abc_ratingbar_material || resId == C0019R.C0021drawable.abc_ratingbar_indicator_material || resId == C0019R.C0021drawable.abc_ratingbar_small_material) {
                            LayerDrawable ld2 = (LayerDrawable) drawable;
                            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0019R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0019R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0019R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                            return true;
                        } else {
                            return false;
                        }
                    ...
                    public ColorStateList getTintListForDrawableRes(Context context, int resId) {
                        if (resId == C0019R.C0021drawable.abc_edit_text_material) {
                            return AppCompatResources.getColorStateList(context, C0019R.C0020color.abc_tint_edittext);
                        }
                        if (resId == C0019R.C0021drawable.abc_switch_track_mtrl_alpha) {
                            return AppCompatResources.getColorStateList(context, C0019R.C0020color.abc_tint_switch_track);
                        }
                        if (resId == C0019R.C0021drawable.abc_switch_thumb_material) {
                            return createSwitchThumbColorStateList(context);
                        }
                        if (resId == C0019R.C0021drawable.abc_btn_default_mtrl_shape) {
                            return createDefaultButtonColorStateList(context);
                        }
                        if (resId == C0019R.C0021drawable.abc_btn_borderless_material) {
                            return createBorderlessButtonColorStateList(context);
                        }
                        if (resId == C0019R.C0021drawable.abc_btn_colored_material) {
                            return createColoredButtonColorStateList(context);
                        }
                        if (resId == C0019R.C0021drawable.abc_spinner_mtrl_am_alpha || resId == C0019R.C0021drawable.abc_spinner_textfield_background_material) {
                        ...
                        if (resId == C0019R.C0021drawable.abc_seekbar_thumb_material) {
                    ...
                    public boolean tintDrawableUsingColorFilter(Context context, int resId, Drawable drawable) {
                        ...
                        } else if (resId == C0019R.C0021drawable.abc_list_divider_mtrl_alpha) {
                            colorAttr = 16842800;
                            colorAttrSet = true;
                            alpha = Math.round(40.8f);
                        } else if (resId == C0019R.C0021drawable.abc_dialog_material_background) {
                            colorAttr = 16842801;
                            colorAttrSet = true;
                        }
                        if (colorAttrSet) {
