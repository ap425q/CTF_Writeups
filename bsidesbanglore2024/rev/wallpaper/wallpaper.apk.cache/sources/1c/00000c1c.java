...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C0555R.attr.snackbarStyle};
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0555R.layout.mtrl_layout_snackbar : C0555R.layout.design_layout_snackbar;
    }
    ...
    public B setAnchorView(View anchorView) {
        ...
        ViewUtils.addOnGlobalLayoutListener(anchorView, this.anchorViewLayoutListener);
        return this;
    }
    ...
    public void startSlideInAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.16
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context2.obtainStyledAttributes(attrs, C0555R.styleable.SnackbarLayout);
            if (a.hasValue(C0555R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, a.getDimensionPixelSize(C0555R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = a.getInt(C0555R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = a.getFloat(C0555R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, a, C0555R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(a.getInt(C0555R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = a.getFloat(C0555R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            a.recycle();
        ...
        private Drawable createThemedBackground() {
            float cornerRadius = getResources().getDimension(C0555R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable background = new GradientDrawable();
            background.setShape(0);
            background.setCornerRadius(cornerRadius);
            int backgroundColor = MaterialColors.layer(this, C0555R.attr.colorSurface, C0555R.attr.colorOnSurface, getBackgroundOverlayColorAlpha());
