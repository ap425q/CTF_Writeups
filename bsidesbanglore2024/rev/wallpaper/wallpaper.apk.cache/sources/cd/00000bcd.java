...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C0555R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0555R.attr.radioButtonStyle);
    }
    ...
    */
    public MaterialRadioButton(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0555R.styleable.MaterialRadioButton
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r1 = com.google.android.material.C0555R.styleable.MaterialRadioButton_buttonTint
        ...
        L2a:
            int r1 = com.google.android.material.C0555R.styleable.MaterialRadioButton_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            int colorControlActivated = MaterialColors.getColor(this, C0555R.attr.colorControlActivated);
            int colorOnSurface = MaterialColors.getColor(this, C0555R.attr.colorOnSurface);
