...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int DEF_STYLE_RES = C0555R.style.Widget_Design_BottomSheet_Modal;
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                ...
                if (yvel < 0.0f) {
                    ...
                    int top5 = (yvel > 0.0f ? 1 : (yvel == 0.0f ? 0 : -1));
                    if (top5 != 0 && Math.abs(xvel) <= Math.abs(yvel)) {
                        if (BottomSheetBehavior.this.fitToContents) {
                        ...
                        if (BottomSheetBehavior.this.fitToContents) {
                            if (Math.abs(currentTop2 - BottomSheetBehavior.this.fitToContentsOffset) < Math.abs(currentTop2 - BottomSheetBehavior.this.collapsedOffset)) {
                                int top8 = BottomSheetBehavior.this.fitToContentsOffset;
                                top = top8;
                                targetState = 3;
                            } else {
                                int top9 = BottomSheetBehavior.this.collapsedOffset;
                                top = top9;
                                targetState = 4;
                            }
                            ...
                            if (currentTop2 < Math.abs(currentTop2 - BottomSheetBehavior.this.collapsedOffset)) {
                                int top10 = BottomSheetBehavior.this.getExpandedOffset();
                                top = top10;
                                targetState = 3;
                            } else {
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        this.peekHeightGestureInsetBuffer = context.getResources().getDimensionPixelSize(C0555R.dimen.mtrl_min_touch_target_size);
        TypedArray a = context.obtainStyledAttributes(attrs, C0555R.styleable.BottomSheetBehavior_Layout);
        this.shapeThemingEnabled = a.hasValue(C0555R.styleable.BottomSheetBehavior_Layout_shapeAppearance);
        boolean hasBackgroundTint = a.hasValue(C0555R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        if (hasBackgroundTint) {
            ColorStateList bottomSheetColor = MaterialResources.getColorStateList(context, a, C0555R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.elevation = a.getDimension(C0555R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        }
        if (a.hasValue(C0555R.styleable.BottomSheetBehavior_Layout_android_maxWidth)) {
            setMaxWidth(a.getDimensionPixelSize(C0555R.styleable.BottomSheetBehavior_Layout_android_maxWidth, -1));
        }
        TypedValue value = a.peekValue(C0555R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (value != null && value.data == -1) {
            setPeekHeight(value.data);
        } else {
            setPeekHeight(a.getDimensionPixelSize(C0555R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        }
        setHideable(a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setGestureInsetBottomIgnored(a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false));
        setFitToContents(a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setDraggable(a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_behavior_draggable, true));
        setSaveFlags(a.getInt(C0555R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(a.getFloat(C0555R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, 0.5f));
        TypedValue value2 = a.peekValue(C0555R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset);
        if (value2 != null && value2.type == 16) {
            setExpandedOffset(value2.data);
        } else {
            setExpandedOffset(a.getDimensionPixelOffset(C0555R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        }
        this.paddingBottomSystemWindowInsets = a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_paddingRightSystemWindowInsets, false);
        this.paddingTopSystemWindowInsets = a.getBoolean(C0555R.styleable.BottomSheetBehavior_Layout_paddingTopSystemWindowInsets, true);
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, final V child, int layoutDirection) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = parent.getResources().getDimensionPixelSize(C0555R.dimen.design_bottom_sheet_peek_height_min);
    ...
    private void createMaterialShapeDrawable(Context context, AttributeSet attrs, boolean hasBackgroundTint, ColorStateList bottomSheetColor) {
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attrs, C0555R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
    ...
    private void updateAccessibilityActions() {
        ...
        if (!this.fitToContents && this.state != 6) {
            this.expandHalfwayActionId = addAccessibilityActionForState(child, C0555R.string.bottomsheet_action_expand_halfway, 6);
        }
