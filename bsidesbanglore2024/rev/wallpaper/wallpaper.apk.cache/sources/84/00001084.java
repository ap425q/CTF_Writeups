...
public class StringsJVM extends StringNumberConversions {
    ...
    public static final String replace(String replace, String oldValue, String newValue, boolean ignoreCase) {
        ...
        int i = 0;
        do {
            stringBuilder.append((CharSequence) replace, i, occurrenceIndex);
        ...
        stringBuilder.append((CharSequence) replace, i, replace.length());
