...
public final class ListBuilderKt {
    ...
    public static final <T> boolean subarrayContentEquals(T[] tArr, int offset, int length, List<?> list) {
        ...
        for (int i = 0; i < length; i++) {
            if (true ^ Intrinsics.areEqual(tArr[offset + i], list.get(i))) {
                return false;
            }
        }
        return true;
    ...
    public static final <T> T[] copyOfUninitializedElements(T[] copyOfUninitializedElements, int newSize) {
        Intrinsics.checkNotNullParameter(copyOfUninitializedElements, "$this$copyOfUninitializedElements");
        T[] tArr = (T[]) Arrays.copyOf(copyOfUninitializedElements, newSize);
    ...
    public static final <E> void resetAt(E[] resetAt, int index) {
        Intrinsics.checkNotNullParameter(resetAt, "$this$resetAt");
        resetAt[index] = null;
    }

    public static final <E> void resetRange(E[] resetRange, int fromIndex, int toIndex) {
