...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C0122R.C0123color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0122R.C0123color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0122R.dimen.cardview_compat_inset_shadow);
