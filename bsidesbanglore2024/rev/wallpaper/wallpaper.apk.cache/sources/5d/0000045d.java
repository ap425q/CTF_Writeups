...
public final class TypedArray {
    ...
    public static final int getColorOrThrow(android.content.res.TypedArray $this$getColorOrThrow, int index) {
    ...
    public static final ColorStateList getColorStateListOrThrow(android.content.res.TypedArray $this$getColorStateListOrThrow, int index) {
    ...
    public static final float getDimensionOrThrow(android.content.res.TypedArray $this$getDimensionOrThrow, int index) {
    ...
    public static final int getDimensionPixelOffsetOrThrow(android.content.res.TypedArray $this$getDimensionPixelOffsetOrThrow, int index) {
    ...
    public static final int getDimensionPixelSizeOrThrow(android.content.res.TypedArray $this$getDimensionPixelSizeOrThrow, int index) {
    ...
    public static final Drawable getDrawableOrThrow(android.content.res.TypedArray $this$getDrawableOrThrow, int index) {
    ...
    public static final float getFloatOrThrow(android.content.res.TypedArray $this$getFloatOrThrow, int index) {
    ...
    public static final Typeface getFontOrThrow(android.content.res.TypedArray $this$getFontOrThrow, int index) {
    ...
    public static final int getIntOrThrow(android.content.res.TypedArray $this$getIntOrThrow, int index) {
    ...
    public static final int getIntegerOrThrow(android.content.res.TypedArray $this$getIntegerOrThrow, int index) {
    ...
    public static final int getResourceIdOrThrow(android.content.res.TypedArray $this$getResourceIdOrThrow, int index) {
    ...
    public static final String getStringOrThrow(android.content.res.TypedArray $this$getStringOrThrow, int index) {
    ...
    public static final CharSequence getTextOrThrow(android.content.res.TypedArray $this$getTextOrThrow, int index) {
    ...
    public static final CharSequence[] getTextArrayOrThrow(android.content.res.TypedArray $this$getTextArrayOrThrow, int index) {
    ...
    public static final <R> R use(android.content.res.TypedArray $this$use, Function1<? super android.content.res.TypedArray, ? extends R> block) {
