...
public final class Color {
    ...
    public static final android.graphics.Color plus(android.graphics.Color $this$plus, android.graphics.Color c) {
        ...
        android.graphics.Color compositeColors = ColorUtils.compositeColors(c, $this$plus);
    ...
    public static final android.graphics.Color toColor(int $this$toColor) {
        android.graphics.Color valueOf = android.graphics.Color.valueOf($this$toColor);
    ...
    public static final ColorSpace getColorSpace(long $this$colorSpace) {
        ColorSpace colorSpace = android.graphics.Color.colorSpace($this$colorSpace);
    ...
    public static final android.graphics.Color convertTo(android.graphics.Color $this$convertTo, ColorSpace.Named colorSpace) {
        ...
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        android.graphics.Color convert = $this$convertTo.convert(ColorSpace.get(colorSpace));
    ...
    public static final android.graphics.Color convertTo(android.graphics.Color $this$convertTo, ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter($this$convertTo, "<this>");
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        android.graphics.Color convert = $this$convertTo.convert(colorSpace);
