...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        View findViewById = findViewById(C0019R.C0022id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0019R.C0022id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0019R.C0022id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0019R.C0022id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0019R.C0022id.image);
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != C0019R.C0022id.list_item) {
                    ...
                    ImageView iconView = (ImageView) convertView.findViewById(C0019R.C0022id.icon);
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    iconView.setImageDrawable(activity.loadIcon(packageManager));
                    TextView titleView = (TextView) convertView.findViewById(C0019R.C0022id.title);
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        ...
                        TextView titleView2 = (TextView) convertView2.findViewById(C0019R.C0022id.title);
