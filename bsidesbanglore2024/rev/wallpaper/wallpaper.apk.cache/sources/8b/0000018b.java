...
public class AppCompatEditText extends EditText implements TintableBackgroundView, OnReceiveContentViewBehavior {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (ic2 != null && mimeTypes != null) {
            ...
            InputConnectionCompat.OnCommitContentListener onCommitContentListener = AppCompatReceiveContentHelper.createOnCommitContentListener(this);
            return InputConnectionCompat.createWrapper(ic2, outAttrs, onCommitContentListener);
        }
        return ic2;
    }
