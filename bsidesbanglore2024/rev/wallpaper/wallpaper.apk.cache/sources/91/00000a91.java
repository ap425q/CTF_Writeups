...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C0555R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            ...
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C0555R.C0558id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C0555R.C0558id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinator = (CoordinatorLayout) this.container.findViewById(C0555R.C0558id.coordinator);
        ...
        coordinator.findViewById(C0555R.C0558id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
    ...
    private static int getThemeResId(Context context, int themeId) {
        if (themeId == 0) {
            ...
            if (context.getTheme().resolveAttribute(C0555R.attr.bottomSheetDialogTheme, outValue, true)) {
                return outValue.resourceId;
            }
            return C0555R.style.Theme_Design_Light_BottomSheetDialog;
        }
        return themeId;
    }
