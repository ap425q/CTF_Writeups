...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setBackground(this, a.getDrawable(C0019R.styleable.ActionMode_background));
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) linearLayout.findViewById(C0019R.C0022id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0019R.C0022id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View findViewById = this.mClose.findViewById(C0019R.C0022id.action_mode_close_button);
