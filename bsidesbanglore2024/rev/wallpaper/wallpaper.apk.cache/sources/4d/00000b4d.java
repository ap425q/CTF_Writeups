...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets(boolean forceRecalculate) {
        ...
        float width2 = (staticLayout3 == null || this.maxLines <= 1) ? measuredWidth : staticLayout3.getWidth();
        StaticLayout staticLayout4 = this.textLayout;
        if (staticLayout4 != null) {
            f = this.maxLines > 1 ? staticLayout4.getLineStart(0) : staticLayout4.getLineLeft(0);
        }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.textToDraw != null && this.drawTitle) {
            ...
            drawTexture = (!this.useTexture || this.expandedTitleTexture == null) ? false : false;
            float f = this.scale;
