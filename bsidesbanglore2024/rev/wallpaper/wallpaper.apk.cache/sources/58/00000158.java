...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        boolean z = true;
        if (getId() == C0019R.C0022id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0019R.C0022id.action_bar);
        this.mContextView = findViewById(C0019R.C0022id.action_context_bar);
    }
