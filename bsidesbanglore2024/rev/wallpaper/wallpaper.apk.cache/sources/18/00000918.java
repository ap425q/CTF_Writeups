...
class GhostViewHolder extends FrameLayout {
    ...
    public GhostViewHolder(ViewGroup parent) {
        ...
        this.mParent = parent;
        parent.setTag(C0484R.C0487id.ghost_view_holder, this);
    ...
    public void onViewRemoved(View child) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == child) || getChildCount() == 0) {
            this.mParent.setTag(C0484R.C0487id.ghost_view_holder, null);
    ...
    public static GhostViewHolder getHolder(ViewGroup parent) {
        return (GhostViewHolder) parent.getTag(C0484R.C0487id.ghost_view_holder);
    }
