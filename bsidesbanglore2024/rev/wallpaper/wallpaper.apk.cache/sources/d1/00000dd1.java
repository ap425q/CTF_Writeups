        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m612contentEqualskV0jMPg(((UByteArray) t).m154unboximpl(), ((UByteArray) t2).m154unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m609contentEqualsFGO6Aew(((UShortArray) t).m414unboximpl(), ((UShortArray) t2).m414unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m610contentEqualsKJPZfPQ(((UIntArray) t).m232unboximpl(), ((UIntArray) t2).m232unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m614contentEqualslec5QzE(((ULongArray) t).m310unboximpl(), ((ULongArray) t2).m310unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m626contentToString2csIQuQ(uByteArray != null ? uByteArray.m154unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m630contentToStringd6D3K8(uShortArray != null ? uShortArray.m414unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m629contentToStringXUkPCBk(uIntArray != null ? uIntArray.m232unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m632contentToStringuLth9ew(uLongArray != null ? uLongArray.m310unboximpl() : null));
            } else {
