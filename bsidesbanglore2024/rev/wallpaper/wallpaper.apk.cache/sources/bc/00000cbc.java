...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0555R.C0558id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0555R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0555R.C0558id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0555R.C0558id.material_clock_period_toggle);
        ...
        this.minuteView = (Chip) findViewById(C0555R.C0558id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0555R.C0558id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C0555R.C0558id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0555R.C0558id.selection_type, 12);
        this.hourView.setTag(C0555R.C0558id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        int checkedId = period == 1 ? C0555R.C0558id.material_clock_period_pm_button : C0555R.C0558id.material_clock_period_am_button;
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0555R.C0558id.material_clock_display, sideToClear);
