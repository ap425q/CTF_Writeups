...
class PathsKt__PathUtilsKt extends PathReadWrite {
    ...
    public static final Path relativeTo(Path relativeTo, Path base) {
        ...
        try {
            return PathUtils.INSTANCE.tryRelativeTo(relativeTo, base);
    ...
    public static final Path relativeToOrNull(Path relativeToOrNull, Path base) {
        ...
        Intrinsics.checkNotNullParameter(base, "base");
        try {
            return PathUtils.INSTANCE.tryRelativeTo(relativeToOrNull, base);
        } catch (IllegalArgumentException e) {
            return null;
        }
    }
    ...
    public static final List<Path> listDirectoryEntries(Path listDirectoryEntries, String glob) throws IOException {
        ...
        DirectoryStream newDirectoryStream = Files.newDirectoryStream(listDirectoryEntries, glob);
        try {
    ...
    private static final Path div(Path div, Path other) {
        ...
        Path resolve = div.resolve(other);
