...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0019R.C0022id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0019R.C0022id.search_edit_frame);
        View findViewById = findViewById(C0019R.C0022id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0019R.C0022id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0019R.C0022id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0019R.C0022id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0019R.C0022id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0019R.C0022id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0019R.C0022id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(findViewById, a.getDrawable(C0019R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a.getDrawable(C0019R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(a.getDrawable(C0019R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(a.getDrawable(C0019R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(a.getDrawable(C0019R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(a.getDrawable(C0019R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(a.getDrawable(C0019R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0019R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0019R.string.abc_searchview_description_search));
