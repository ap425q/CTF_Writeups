...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{16843049}, C0019R.attr.dropDownListViewStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(C0019R.C0022id.title);
        this.mTitleView = textView;
        int i = this.mTextAppearance;
        if (i != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0019R.C0022id.shortcut);
        ImageView imageView = (ImageView) findViewById(C0019R.C0022id.submenuarrow);
        this.mSubMenuArrowView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0019R.C0022id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0019R.C0022id.content);
    }
    ...
    private void insertIconView() {
        ...
        ImageView imageView = (ImageView) inflater.inflate(C0019R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton radioButton = (RadioButton) inflater.inflate(C0019R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox checkBox = (CheckBox) inflater.inflate(C0019R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
