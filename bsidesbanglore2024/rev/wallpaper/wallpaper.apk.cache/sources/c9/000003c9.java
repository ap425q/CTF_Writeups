...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0168R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0168R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0168R.C0170drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0168R.C0171id.notification_main_column);
            outerView.addView(C0168R.C0171id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0168R.C0171id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0168R.C0171id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0168R.C0171id.title, 8);
            outerView.setViewVisibility(C0168R.C0171id.text2, 8);
            outerView.setViewVisibility(C0168R.C0171id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0168R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0168R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0168R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0168R.C0171id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0168R.C0171id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0168R.C0171id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0168R.C0171id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0168R.layout.notification_action_tombstone : C0168R.layout.notification_action);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0168R.C0171id.action_image, createColoredBitmap(icon, this.mBuilder.mContext.getResources().getColor(C0168R.C0169color.notification_action_color_filter)));
            }
            button.setTextViewText(C0168R.C0171id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0168R.C0171id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0168R.C0171id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m57clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m58clone() {
            WearableExtender that = new WearableExtender();
