...
public final class UnsignedUtils {
    ...
    public static final int m417uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m164constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m418uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m164constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m419ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m242constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        } else if (v1 >= 0) {
            return ULong.m242constructorimpl(v1 / v2);
        } else {
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            return ULong.m242constructorimpl((ulongCompare(ULong.m242constructorimpl(rem), ULong.m242constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m420ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            ...
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            if (ulongCompare(ULong.m242constructorimpl(rem), ULong.m242constructorimpl(v2)) >= 0) {
                j = v2;
            }
            return ULong.m242constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        if (!Double.isNaN(v) && v > uintToDouble(0)) {
            ...
            return v <= d ? UInt.m164constructorimpl((int) v) : UInt.m164constructorimpl(UInt.m164constructorimpl((int) (v - d)) + UInt.m164constructorimpl(Integer.MAX_VALUE));
        }
        return 0;
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0L)) {
            ...
            return v < ((double) Long.MAX_VALUE) ? ULong.m242constructorimpl((long) v) : ULong.m242constructorimpl(ULong.m242constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
