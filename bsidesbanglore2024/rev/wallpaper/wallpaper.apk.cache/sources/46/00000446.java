        ...
        while (true) {
            ...
            if (next != i && ((depth = parser.getDepth()) >= innerDepth2 || type != 3)) {
                if (type != 2 || depth > innerDepth2) {
                    ...
                    TypedArray a = obtainAttributes(resources, theme2, attrs, C0168R.styleable.ColorStateListItem);
                    int resourceId = a.getResourceId(C0168R.styleable.ColorStateListItem_android_color, -1);
                    if (resourceId != -1 && !isColorInt(resources, resourceId)) {
                        try {
                            ...
                            baseColor = a.getColor(C0168R.styleable.ColorStateListItem_android_color, -65281);
                        }
                    } else {
                        int baseColor2 = C0168R.styleable.ColorStateListItem_android_color;
                    ...
                    if (BuildCompat.isAtLeastS() && a.hasValue(C0168R.styleable.ColorStateListItem_android_lStar)) {
                        lStar = a.getFloat(C0168R.styleable.ColorStateListItem_android_lStar, -1.0f);
                    } else {
                        lStar = a.getFloat(C0168R.styleable.ColorStateListItem_lStar, -1.0f);
                    }
                    a.recycle();
                    int j = 0;
                    ...
                    while (i2 < numAttrs) {
                        ...
                        int type2 = type;
                        if (stateResId != 16843173 && stateResId != 16843551 && stateResId != C0168R.attr.alpha && stateResId != C0168R.attr.lStar) {
                            int j2 = j + 1;
