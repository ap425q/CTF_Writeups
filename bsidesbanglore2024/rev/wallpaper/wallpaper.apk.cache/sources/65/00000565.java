...
public final class LongSparseArray {
    ...
    public static final <T> android.util.LongSparseArray<T> plus(android.util.LongSparseArray<T> longSparseArray, android.util.LongSparseArray<T> other) {
        ...
        android.util.LongSparseArray longSparseArray2 = new android.util.LongSparseArray(longSparseArray.size() + other.size());
    ...
    public static final <T> T getOrElse(android.util.LongSparseArray<T> longSparseArray, long key, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(longSparseArray, "<this>");
