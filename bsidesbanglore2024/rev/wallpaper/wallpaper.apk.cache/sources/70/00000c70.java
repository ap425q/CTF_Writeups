...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        float popupCornerRadius = this.context.getResources().getDimensionPixelOffset(C0555R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = this.context.getResources().getDimensionPixelOffset(C0555R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C0555R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        int drawableResId = IS_LOLLIPOP ? C0555R.C0557drawable.mtrl_dropdown_arrow : C0555R.C0557drawable.mtrl_ic_arrow_drop_down;
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, drawableResId));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0555R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        ...
        int rippleColor = MaterialColors.getColor(editText, C0555R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C0555R.attr.colorSurface);
