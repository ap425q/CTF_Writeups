    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0019R.C0022id.topPanel) {
                    topPanel = child;
                } else if (id == C0019R.C0022id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0019R.C0022id.contentPanel && id != C0019R.C0022id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
