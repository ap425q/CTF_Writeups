...
public class DependencyGraph {
    ...
    private String nodeDefinition(WidgetRun run) {
        ...
        if (!z) {
            definition = name + "_HORIZONTAL";
        } else {
            definition = name + "_VERTICAL";
        }
        String definition4 = ((definition + " [shape=none, label=<") + "<TABLE BORDER=\"0\" CELLSPACING=\"0\" CELLPADDING=\"2\">") + "  <TR>";
        if (!z) {
            String definition5 = definition4 + "    <TD ";
            if (run.start.resolved) {
                definition5 = definition5 + " BGCOLOR=\"green\"";
            }
            definition2 = definition5 + " PORT=\"LEFT\" BORDER=\"1\">L</TD>";
        } else {
            String definition6 = definition4 + "    <TD ";
            if (run.start.resolved) {
                definition6 = definition6 + " BGCOLOR=\"green\"";
            }
            definition2 = definition6 + " PORT=\"TOP\" BORDER=\"1\">T</TD>";
        }
        String definition7 = definition2 + "    <TD BORDER=\"1\" ";
        if (run.dimension.resolved && !run.widget.measured) {
            ...
            definition7 = definition7 + " BGCOLOR=\"lightgray\" ";
        } else if (!run.dimension.resolved && run.widget.measured) {
            definition7 = definition7 + " BGCOLOR=\"yellow\" ";
        }
        if (behaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            definition7 = definition7 + "style=\"dashed\"";
        }
        String group = "";
        if (runGroup != null) {
            group = " [" + (runGroup.groupIndex + 1) + "/" + RunGroup.index + "]";
        }
        String definition8 = definition7 + ">" + name + group + " </TD>";
        if (!z) {
            String definition9 = definition8 + "    <TD ";
            if (run.end.resolved) {
                definition9 = definition9 + " BGCOLOR=\"green\"";
            }
            definition3 = definition9 + " PORT=\"RIGHT\" BORDER=\"1\">R</TD>";
        } else {
            String definition10 = definition8 + "    <TD ";
            if ((run instanceof VerticalWidgetRun) && ((VerticalWidgetRun) run).baseline.resolved) {
                definition10 = definition10 + " BGCOLOR=\"green\"";
            }
            String definition11 = (definition10 + " PORT=\"BASELINE\" BORDER=\"1\">b</TD>") + "    <TD ";
            if (run.end.resolved) {
                definition11 = definition11 + " BGCOLOR=\"green\"";
            }
            definition3 = definition11 + " PORT=\"BOTTOM\" BORDER=\"1\">B</TD>";
        }
