...
class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0019R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = inflate;
        this.mMessageView = (TextView) inflate.findViewById(C0019R.C0022id.message);
        ...
        layoutParams.windowAnimations = C0019R.style.Animation_AppCompat_Tooltip;
