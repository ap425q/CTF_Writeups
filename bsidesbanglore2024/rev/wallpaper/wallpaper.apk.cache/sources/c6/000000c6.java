...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context baseContext) {
        ...
        androidx.appcompat.view.ContextThemeWrapper wrappedContext = new androidx.appcompat.view.ContextThemeWrapper(baseContext, C0019R.style.Theme_AppCompat_Empty);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                DecorContentParent decorContentParent = (DecorContentParent) subDecor.findViewById(C0019R.C0022id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(C0019R.C0022id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0019R.C0022id.action_bar_activity_content);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(actionBarContext, (AttributeSet) null, C0019R.attr.actionModePopupWindowStyle);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0019R.C0022id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    */
    ...
    private void updateStatusGuardColor(View v) {
        ...
        if (lightStatusBar) {
            color = ContextCompat.getColor(this.mContext, C0019R.C0020color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(this.mContext, C0019R.C0020color.abc_decor_view_status_guard);
        }
    ...
    public static final class PanelFeatureState {
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0019R.layout.abc_list_menu_item_layout);
