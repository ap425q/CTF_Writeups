...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0555R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0555R.attr.snackbarButtonStyle, C0555R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) inflater.inflate(hasSnackbarContentStyleAttrs(context) ? C0555R.layout.mtrl_layout_snackbar_include : C0555R.layout.design_layout_snackbar_include, parent, false);
