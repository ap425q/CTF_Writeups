...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1257getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m69boximpl(result);
            notifyAll();
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m79unboximpl());
                }
            }
        }
    }
