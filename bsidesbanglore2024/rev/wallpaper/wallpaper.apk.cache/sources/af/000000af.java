...
public class AlertController {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x009f, code lost:
        r1 = r9.findViewById(androidx.appcompat.C0019R.C0022id.titleDividerNoCustom);
     */
    ...
    */
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0019R.C0022id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0019R.C0022id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0019R.C0022id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0019R.C0022id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0019R.C0022id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0019R.C0022id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0019R.C0022id.scrollView);
