...
@DebugMetadata(m11c = "androidx.core.view.ViewKt$allViews$1", m10f = "View.kt", m9i = {0}, m8l = {406, 408}, m7m = "invokeSuspend", m6n = {"$this$sequence"}, m5s = {"L$0"})
...
final class ViewKt$allViews$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super View>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if ($this$sequence.yieldAll(ViewGroup.getDescendants((ViewGroup) view), viewKt$allViews$1) == coroutine_suspended) {
                return coroutine_suspended;
            }
