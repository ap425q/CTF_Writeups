...
public final class ParameterizedTypeImpl implements ParameterizedType, TypeImpl {
    ...
    public String getTypeName() {
        ...
        if (type != null) {
            ...
            $this$buildString.append(typeToString2);
            $this$buildString.append("$");
            $this$buildString.append(this.rawType.getSimpleName());
        } else {
            typeToString = TypesJVMKt.typeToString(this.rawType);
            $this$buildString.append(typeToString);
        }
        Type[] typeArr = this.typeArguments;
        if (!(typeArr.length == 0)) {
            ArraysKt.joinTo(typeArr, $this$buildString, (r15 & 2) != 0 ? ", " : null, (r15 & 4) != 0 ? "" : "<", (r15 & 8) != 0 ? "" : ">", (r15 & 16) != 0 ? -1 : 0, (r15 & 32) != 0 ? "..." : null, (r15 & 64) != 0 ? null : ParameterizedTypeImpl$getTypeName$1$1.INSTANCE);
        }
